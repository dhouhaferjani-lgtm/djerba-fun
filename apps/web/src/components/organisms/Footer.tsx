          ...
          <div className="lg:col-span-1">
            <Link href={`/${locale}`} className="inline-block mb-6">
              <span className="text-2xl font-bold">
                <span className="text-[#8BC34A]">Go</span> Adventure
              </span>
            </Link>
            <p className="text-neutral-400 leading-relaxed mb-6">{t('tagline')}</p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#0D642E] transition-colors"
              >

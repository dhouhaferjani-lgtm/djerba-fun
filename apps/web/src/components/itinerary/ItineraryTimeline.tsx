...
export default function ItineraryTimeline({ stops, locale }: ItineraryTimelineProps) {
      ...
      <div className="relative">
        ...
        <div className="space-y-8">
          {sortedStops.map((stop, index) => {
            ...
            const title =
              typeof stop.title === 'string' ? stop.title : stop.title[locale as 'en' | 'fr'];
            const description =
            ...
            return (
              <div key={stop.id} className="relative pl-12">
                {/* Stop marker */}
                <div className="absolute left-0 top-0 flex h-8 w-8 items-center justify-center rounded-full border-4 border-white bg-primary shadow-md">

    ...
    <div className="max-w-2xl mx-auto">
      <div className="text-center space-y-6">
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
          ...
          <p className="text-2xl font-bold text-primary">{booking.code}</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 text-left">
          ...
          <div className="space-y-3 text-sm">
            <div>
              <span className="text-gray-600">{t('booking_number')}:</span>
              <p className="font-medium text-gray-900">{booking.code}</p>
            </div>
            <div>
              <span className="text-gray-600">{t('date_time')}:</span>
              <p className="font-medium text-gray-900">{formatDateTime(booking.startsAt)}</p>
            </div>
            <div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            {t('email_sent')} <strong>{booking.travelers[0]?.email}</strong>
          </p>
        </div>

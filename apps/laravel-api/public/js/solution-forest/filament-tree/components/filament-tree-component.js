...
var er = (h, N) => () => (N || h((N = { exports: {} }).exports, N), N.exports);
var tr = (h, N, S, Y) => {
  if ((N && typeof N == 'object') || typeof N == 'function')
    for (let k of Ji(N))
      !Zi.call(h, k) &&
        k !== S &&
        On(h, k, { get: () => N[k], enumerable: !(Y = Qi(N, k)) || Y.enumerable });
  return h;
};
var Mn = (h, N, S) => (
  (S = h != null ? Gi(Ki(h)) : {}),
  tr(N || !h || !h.__esModule ? On(S, 'default', { value: h, enumerable: !0 }) : S, h)
);
var at = er((Rn, bt) => {
  (function (h, N) {
    'use strict';
    ...
    var S = [],
      ...
      M = function (t) {
        return (
          typeof t == 'function' && typeof t.nodeType != 'number' && typeof t.item != 'function'
        );
      },
      Re = function (t) {
    ...
    function zt(e, t, n) {
      ...
      if (((s.text = e), t))
        for (i in Wn)
          ((o = t[i] || (t.getAttribute && t.getAttribute(i))), o && s.setAttribute(i, o));
    ...
    ((r.fn = r.prototype =
      {
        ...
        get: function (e) {
          return e == null ? k.call(this) : e < 0 ? this[e + this.length] : this[e];
        },
      ...
      r.extend({
        ...
        each: function (e, t) {
          var n,
            i = 0;
          if (Ct(e)) for (n = e.length; i < n && t.call(e[i], i, e[i]) !== !1; i++);
        ...
        makeArray: function (e, t) {
          ...
          return (
            e != null &&
              (Ct(Object(e)) ? r.merge(n, typeof e == 'string' ? [e] : e) : I.call(n, e)),
            n
          );
        },
        ...
        grep: function (e, t, n) {
          for (var i, o = [], s = 0, a = e.length, l = !n; s < a; s++)
        ...
        map: function (e, t, n) {
          var i,
            ...
            s = 0,
            a = [];
          if (Ct(e)) for (i = e.length; s < i; s++) ((o = t(e[s], s, n)), o != null && a.push(o));
          else for (s in e) ((o = t(e[s], s, n)), o != null && a.push(o));
          return W(a);
        },
        guid: 1,
        support: O,
      }),
      typeof Symbol == 'function' && (r.fn[Symbol.iterator] = S[Symbol.iterator]),
      r.each(
    ...
    (function () {
      ...
      try {
        (s.apply((S = k.call(Te.childNodes)), Te.childNodes), S[Te.childNodes.length].nodeType);
      } catch {
        s = {
          apply: function (c, p) {
            Tt.apply(c, k.call(p));
      ...
      function z(u, c, p, y) {
        var m,
          ...
          q = c && c.ownerDocument,
          _ = c ? c.nodeType : 9;
        if (((p = p || []), typeof u != 'string' || !u || (_ !== 1 && _ !== 9 && _ !== 11)))
          return p;
        if (!y && (je(c), (c = c || a), f)) {
          if (_ !== 11 && (w = fe.exec(u)))
            if ((m = w[1])) {
              ...
              else if (q && (T = q.getElementById(m)) && z.contains(c, T) && T.id === m)
                return (s.call(p, T), p);
            } else {
              if (w[2]) return (s.apply(p, c.getElementsByTagName(u)), p);
              if ((m = w[3]) && c.getElementsByClassName)
                return (s.apply(p, c.getElementsByClassName(m)), p);
            }
          if (!Z[u + ' '] && (!d || !d.test(u))) {
            if (((L = u), (q = c), _ === 1 && (Xt.test(u) || rt.test(u)))) {
              for (
                q = (_t.test(u) && Wt(c.parentNode)) || c,
                  (q != c || !O.scope) &&
                    ((A = c.getAttribute('id'))
                      ? (A = r.escapeSelector(A))
                      : c.setAttribute('id', (A = b))),
                  X = st(u),
                  C = X.length;
                C--;
              )
                X[C] = (A ? '#' + A : ':scope') + ' ' + yt(X[C]);
              L = X.join(',');
            }
            try {
      ...
      function gt() {
        var u = [];
        function c(p, y) {
          return (u.push(p + ' ') > t.cacheLength && delete c[u.shift()], (c[p + ' '] = y));
        }
        return c;
      }
      function pe(u) {
            ...
            ? c.parentNode && c.disabled === !1
              ? 'label' in c
                ? 'label' in c.parentNode
                  ...
                  : c.disabled === u
                : c.isDisabled === u || (c.isDisabled !== !u && Yi(c) === u)
              : c.disabled === u
            : 'label' in c
              ? c.disabled === u
              : !1;
      ...
      function Oe(u) {
        return pe(function (c) {
          return (
            (c = +c),
            pe(function (p, y) {
              for (var m, C = u([], p.length, c), T = C.length; T--; )
                p[(m = C[T])] && (p[m] = !(y[m] = p[m]));
            })
          );
        });
          ...
          p == a ||
            ...
            O.getById
              ...
              : ((t.filter.ID = function (y) {
                  var m = y.replace(Ne, Se);
                  return function (C) {
                    var T = typeof C.getAttributeNode < 'u' && C.getAttributeNode('id');
                    return T && T.value === m;
                  };
                }),
                (t.find.ID = function (y, m) {
                  if (typeof m.getElementById < 'u' && f) {
                    var C,
                      T,
                      A,
                      w = m.getElementById(y);
                    if (w) {
                      if (((C = w.getAttributeNode('id')), C && C.value === y)) return [w];
                      for (A = m.getElementsByName(y), T = 0; (w = A[T++]); )
                        if (((C = w.getAttributeNode('id')), C && C.value === y)) return [w];
                    }
                    return [];
                  }
            ...
            (t.find.CLASS = function (y, m) {
              if (typeof m.getElementsByClassName < 'u' && f) return m.getElementsByClassName(y);
            }),
            (d = []),
            Ue(function (y) {
              var m;
              ((l.appendChild(y).innerHTML =
                ...
                y.querySelectorAll('[selected]').length ||
                  d.push('\\[' + U + '*(?:value|' + ye + ')'),
                y.querySelectorAll('[id~=' + b + '-]').length || d.push('~='),
                y.querySelectorAll('a#' + b + '+*').length || d.push('.#.+[+~]'),
                y.querySelectorAll(':checked').length || d.push(':checked'),
                (m = a.createElement('input')),
                m.setAttribute('type', 'hidden'),
                y.appendChild(m).setAttribute('name', 'D'),
                (l.appendChild(y).disabled = !0),
                y.querySelectorAll(':disabled').length !== 2 && d.push(':enabled', ':disabled'),
                (m = a.createElement('input')),
                m.setAttribute('name', ''),
                y.appendChild(m),
            ...
            (K = function (y, m) {
              if (y === m) return ((o = !0), 0);
              var C = !y.compareDocumentPosition - !m.compareDocumentPosition;
              return (
                C ||
                ((C =
                  (y.ownerDocument || y) == (m.ownerDocument || m)
                    ? y.compareDocumentPosition(m)
                    : 1),
                C & 1 || (!O.sortDetached && m.compareDocumentPosition(y) === C)
                  ? y === a || (y.ownerDocument == Te && z.contains(Te, y))
                    ? -1
                    : m === a || (m.ownerDocument == Te && z.contains(Te, m))
                      ? 1
                      : i
      ...
      ((z.matches = function (u, c) {
        ...
        (z.matchesSelector = function (u, c) {
          if ((je(u), f && !Z[c + ' '] && (!d || !d.test(c))))
            try {
              var p = v.call(u, c);
              if (p || O.disconnectedMatch || (u.document && u.document.nodeType !== 11)) return p;
            } catch {
              Z(c, !0);
            }
        ...
        (z.contains = function (u, c) {
          return ((u.ownerDocument || u) != a && je(u), r.contains(u, c));
        }),
        (z.attr = function (u, c) {
          (u.ownerDocument || u) != a && je(u);
          var p = t.attrHandle[c.toLowerCase()],
            y = p && ae.call(t.attrHandle, c.toLowerCase()) ? p(u, c, !f) : void 0;
        ...
        (r.uniqueSort = function (u) {
          var c,
            ...
            y = 0,
            m = 0;
          if (((o = !O.sortStable), (i = !O.sortStable && k.call(u, 0)), Bn.call(u, K), o)) {
        ...
        (t = r.expr =
          {
            ...
            filter: {
              TAG: function (u) {
                var c = u.replace(Ne, Se).toLowerCase();
                return u === '*'
                  ? function () {
                      return !0;
                    }
                          ...
                          : c === '!='
                            ...
                            : c === '^='
                              ...
                              : c === '*='
                                ? p && m.indexOf(p) > -1
                                : c === '$='
                                  ? p && m.slice(-p.length) === p
                                  : c === '~='
                                    ? (' ' + m.replace($, ' ') + ' ').indexOf(p) > -1
                                    : c === '|='
                                      ? m === p || m.slice(0, p.length + 1) === p + '-'
                                      : !1)
                      : !0;
                };
              },
                ...
                return y === 1 && m === 0
                  ...
                  : function (w, X, L) {
                      var q,
                        ...
                        V,
                        se,
                        ee = C !== T ? 'nextSibling' : 'previousSibling',
                        le = w.parentNode,
                        xe = A && w.nodeName.toLowerCase(),
                        Ve = !L && !A,
                        te = !1;
                      if (le) {
                        if (C) {
                          for (; ee; ) {
                            for (j = w; (j = j[ee]); )
                              if (A ? Q(j, xe) : j.nodeType === 1) return !1;
                            se = ee = u === 'only' && !se && 'nextSibling';
                          }
                          return !0;
                        }
                        if (((se = [T ? le.firstChild : le.lastChild]), T && Ve)) {
                          for (
                            _ = le[b] || (le[b] = {}),
                              q = _[u] || [],
                              V = q[0] === g && q[1],
                              te = V && q[2],
                              j = V && le.childNodes[V];
                            (j = (++V && j && j[ee]) || (te = V = 0) || se.pop());
                          )
                            if (j.nodeType === 1 && ++te && j === w) {
                              _[u] = [g, V, te];
                              break;
                            }
                        } else if (
                          ...
                          for (
                            ...
                            (j = (++V && j && j[ee]) || (te = V = 0) || se.pop()) &&
                            !(
                              (A ? Q(j, xe) : j.nodeType === 1) &&
                              ++te &&
                              (Ve && ((_ = j[b] || (j[b] = {})), (_[u] = [g, te])), j === w)
                            );
                          );
                        return ((te -= m), te === y || (te % y === 0 && te / y >= 0));
                      }
                    };
              },
              PSEUDO: function (u, c) {
                  ...
                  : y.length > 1
                    ? ((p = [u, u, '', c]),
                      t.setFilters.hasOwnProperty(u.toLowerCase())
                        ? pe(function (m, C) {
                            for (var T, A = y(m, c), w = A.length; w--; )
                              ((T = E.call(m, A[w])), (m[T] = !(C[T] = A[w])));
                          })
                        : function (m) {
                            return y(m, 0, p);
                          })
            ...
            pseudos: {
              not: pe(function (u) {
                ...
                return y[b]
                  ? pe(function (m, C, T, A) {
                      for (var w, X = y(m, null, A, []), L = m.length; L--; )
                        (w = X[L]) && (m[L] = !(C[L] = w));
                    })
                  : function (m, C, T) {
                      return ((c[0] = m), y(c, null, T, p), (c[0] = null), !p.pop());
                    };
              }),
              has: pe(function (u) {
                return function (c) {
              ...
              contains: pe(function (u) {
                return (
                  (u = u.replace(Ne, Se)),
                  function (c) {
                    return (c.textContent || r.text(c)).indexOf(u) > -1;
                  }
                );
              }),
              lang: pe(function (u) {
                return (
                  ot.test(u || '') || z.error('unsupported lang: ' + u),
              ...
              focus: function (u) {
                return u === Bi() && a.hasFocus() && !!(u.type || u.href || ~u.tabIndex);
              },
              enabled: Hn(!1),
              disabled: Hn(!0),
              checked: function (u) {
                return (Q(u, 'input') && !!u.checked) || (Q(u, 'option') && !!u.selected);
              },
              selected: function (u) {
              ...
              button: function (u) {
                return (Q(u, 'input') && u.type === 'button') || Q(u, 'button');
              },
              text: function (u) {
                var c;
                return (
              ...
              lt: Oe(function (u, c, p) {
                var y;
                for (p < 0 ? (y = p + c) : p > c ? (y = c) : (y = p); --y >= 0; ) u.push(y);
                return u;
              }),
              gt: Oe(function (u, c, p) {
                for (var y = p < 0 ? p + c : p; ++y < c; ) u.push(y);
                return u;
              }),
            },
          }),
      ...
      function st(u, c) {
        ...
        for (T = u, A = [], w = t.preFilter; T; ) {
          ((!p || (y = J.exec(T))) && (y && (T = T.slice(y[0].length) || T), A.push((m = []))),
            (p = !1),
            (y = rt.exec(T)) &&
              ((p = y.shift()),
          ...
          for (C in t.filter)
            (y = be[C].exec(T)) &&
              (!w[C] || (y = w[C](y))) &&
              ((p = y.shift()), m.push({ value: p, type: C, matches: y }), (T = T.slice(p.length)));
          if (!p) break;
        }
        return c ? T.length : T ? z.error(u) : B(u, A).slice(0);
      }
      function yt(u) {
        for (var c = 0, p = u.length, y = ''; c < p; c++) y += u[c].value;
        return y;
      }
      function vt(u, c, p) {
        var y = c.dir,
        ...
        return c.first
          ? function (w, X, L) {
              for (; (w = w[y]); ) if (w.nodeType === 1 || T) return u(w, X, L);
              return !1;
            }
          : function (w, X, L) {
              var q,
                ...
                j = [g, A];
              if (L) {
                for (; (w = w[y]); ) if ((w.nodeType === 1 || T) && u(w, X, L)) return !0;
              } else
                for (; (w = w[y]); )
                  if (w.nodeType === 1 || T)
                    if (((_ = w[b] || (w[b] = {})), m && Q(w, m))) w = w[y] || w;
                    else {
                      if ((q = _[C]) && q[0] === g && q[1] === A) return (j[2] = q[2]);
                      if (((_[C] = j), (j[2] = u(w, X, L)))) return !0;
                    }
              return !1;
            };
      }
      function Ft(u) {
        return u.length > 1
          ? function (c, p, y) {
              for (var m = u.length; m--; ) if (!u[m](c, p, y)) return !1;
              return !0;
            }
          : u[0];
      }
      function Ui(u, c, p) {
        for (var y = 0, m = c.length; y < m; y++) z(u, c[y], p);
        return p;
      }
      function mt(u, c, p, y, m) {
        for (var C, T = [], A = 0, w = u.length, X = c != null; A < w; A++)
          (C = u[A]) && (!p || p(C, y, m)) && (T.push(C), X && c.push(A));
        return T;
      }
        ...
        return (
          ...
          pe(function (T, A, w, X) {
            var L,
              ...
              se = [],
              ee = A.length,
              le = T || Ui(c || '*', w.nodeType ? [w] : w, []),
              xe = u && (T || !c) ? mt(le, V, u, w, X) : le;
            if ((p ? ((j = m || (T ? u : ee || y) ? [] : A), p(xe, j, w, X)) : (j = xe), y))
              for (L = mt(j, se), y(L, [], w, X), q = L.length; q--; )
                (_ = L[q]) && (j[se[q]] = !(xe[se[q]] = _));
            if (T) {
              if (m || u) {
                if (m) {
                  for (L = [], q = j.length; q--; ) (_ = j[q]) && L.push((xe[q] = _));
                  m(null, (j = []), L, X);
                }
                for (q = j.length; q--; )
                  (_ = j[q]) && (L = m ? E.call(T, _) : V[q]) > -1 && (T[L] = !(A[L] = _));
              }
            } else
              ((j = mt(j === A ? j.splice(ee, j.length) : j)),
                m ? m(null, A, j, X) : s.apply(A, j));
          })
        );
      }
      function Bt(u) {
        for (
          var c,
            ...
            L = [
              function (q, _, j) {
                var V = (!C && (j || _ != n)) || ((c = _).nodeType ? w(q, _, j) : X(q, _, j));
                return ((c = null), V);
              },
            ];
          A < m;
          ...
          if ((p = t.relative[u[A].type])) L = [vt(Ft(L), p)];
          else {
            if (((p = t.filter[u[A].type].apply(null, u[A].matches)), p[b])) {
              for (y = ++A; y < m && !t.relative[u[y].type]; y++);
              return Yt(
                A > 1 && Ft(L),
                A > 1 &&
                  yt(u.slice(0, A - 1).concat({ value: u[A - 2].type === ' ' ? '*' : '' })).replace(
                    Ge,
                    '$1'
                  ),
                p,
        ...
        var p = c.length > 0,
          ...
          m = function (C, T, A, w, X) {
            var L,
              ...
              le = n,
              xe = C || (y && t.find.TAG('*', X)),
              Ve = (g += le == null ? 1 : Math.random() || 0.1),
              te = xe.length;
            for (X && (n = T == a || T || X); V !== te && (L = xe[V]) != null; V++) {
              if (y && L) {
                for (q = 0, !T && L.ownerDocument != a && (je(L), (A = !f)); (_ = u[q++]); )
                  if (_(L, T || a, A)) {
                    s.call(w, L);
                    break;
                  }
            ...
            if (((j += V), p && V !== j)) {
              for (q = 0; (_ = c[q++]); ) _(se, ee, T, A);
              if (C) {
                if (j > 0) for (; V--; ) se[V] || ee[V] || (ee[V] = Yn.call(w));
                ee = mt(ee);
              }
              (s.apply(w, ee), X && !C && ee.length > 0 && j + c.length > 1 && r.uniqueSort(w));
            }
      ...
      function Pn(u, c, p, y) {
        ...
        if (((p = p || []), L.length === 1)) {
          if (
            ...
            if (((c = (t.find.ID(T.matches[0].replace(Ne, Se), c) || [])[0]), c))
              X && (c = c.parentNode);
            else return p;
          ...
          for (
            ...
            m-- && ((T = C[m]), !t.relative[(A = T.type)]);
          )
            if (
              (w = t.find[A]) &&
              (y = w(T.matches[0].replace(Ne, Se), (_t.test(C[0].type) && Wt(c.parentNode)) || c))
            ) {
              if ((C.splice(m, 1), (u = y.length && yt(C)), !u)) return (s.apply(p, y), p);
              break;
            }
        }
        return ((X || $t(u, L))(y, c, !f, p, !c || (_t.test(u) && Wt(c.parentNode)) || c), p);
      }
    ...
    ((r.filter = function (e, t, n) {
      ...
      r.fn.extend({
        ...
        is: function (e) {
          return !!wt(this, typeof e == 'string' && Gt.test(e) ? r(e) : e || [], !1).length;
        },
      }));
    var Jt,
      Vn = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
      Gn = (r.fn.init = function (e, t, n) {
        var i, o;
        if (!e) return this;
          ...
          if (
            ...
            if (i[1]) {
              if (
                ...
                r.merge(this, r.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : P, !0)),
                Qt.test(i[1]) && r.isPlainObject(t))
              )
                for (i in t) M(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
              return this;
            } else
              return ((o = P.getElementById(i[2])), o && ((this[0] = o), (this.length = 1)), this);
        ...
        if (!Gt.test(e)) {
          for (; i < o; i++)
            for (n = this[i]; n && n !== t; n = n.parentNode)
              if (
                n.nodeType < 11 &&
                (a ? a.index(n) > -1 : n.nodeType === 1 && r.find.matchesSelector(n, e))
              ) {
                s.push(n);
                break;
              }
    ...
    r.each(
      {
        ...
        contents: function (e) {
          return e.contentDocument != null && Y(e.contentDocument)
            ? e.contentDocument
            : (Q(e, 'template') && (e = e.content || e), r.merge([], e.childNodes));
        },
      },
      function (e, t) {
        r.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 && (Jn[e] || r.uniqueSort(o), Qn.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
      ...
      var t,
        ...
        d = {
          ...
          remove: function () {
            return (
              r.each(arguments, function (v, b) {
                for (var g; (g = r.inArray(b, s, g)) > -1; ) (s.splice(g, 1), g <= l && l--);
              }),
              this
            );
          },
          ...
          fireWith: function (v, b) {
            return (
              o || ((b = b || []), (b = [v, b.slice ? b.slice() : b]), a.push(b), t || f()),
              this
            );
          },
          fire: function () {
              ...
              return r
                .Deferred(function (a) {
                  (r.each(t, function (l, f) {
                    var d = M(s[f[4]]) && s[f[4]];
                    o[f[1]](function () {
                      var v = d && d.apply(this, arguments);
                      v && M(v.promise)
                        ? v.promise().progress(a.notify).done(a.resolve).fail(a.reject)
                        : a[f[0] + 'With'](this, d ? [v] : arguments);
                    });
                  }),
                    (s = null));
                })
                ...
                return function () {
                  var H = this,
                    ...
                    R = function () {
                      var K, ye;
                      if (!(v < f)) {
                        if (((K = g.apply(H, B)), K === b.promise()))
                          throw new TypeError('Thenable self-resolution');
                        ((ye = K && (typeof K == 'object' || typeof K == 'function') && K.then),
                          M(ye)
                            ? x
                              ? ye.call(K, d(f, b, _e, x), d(f, b, ut, x))
                              : (f++,
                                ye.call(
                                  K,
                                  d(f, b, _e, x),
                                  d(f, b, ut, x),
                                  d(f, b, _e, b.notifyWith)
                                ))
                            : (g !== _e && ((H = void 0), (B = [K])), (x || b.resolveWith)(H, B)));
                      }
                    },
                    Z = x
                      ? R
                      : function () {
                          try {
                            ...
                            (r.Deferred.exceptionHook && r.Deferred.exceptionHook(K, Z.error),
                              v + 1 >= f &&
                                (g !== ut && ((H = void 0), (B = [K])), b.rejectWith(H, B)));
                          }
                        };
                  v
                    ? Z()
                    : (r.Deferred.getErrorHook
                        ? (Z.error = r.Deferred.getErrorHook())
                        : r.Deferred.getStackHook && (Z.error = r.Deferred.getStackHook()),
                      h.setTimeout(Z));
                };
              }
              return r
                .Deferred(function (v) {
                  (t[0][3].add(d(0, v, M(l) ? l : _e, v.notifyWith)),
      ...
      when: function (e) {
        var t = arguments.length,
          ...
          a = function (l) {
            return function (f) {
              ((i[l] = this),
                (o[l] = arguments.length > 1 ? k.call(arguments) : f),
                --t || s.resolveWith(i, o));
            };
          };
        if (
    ...
    ((r.Deferred.exceptionHook = function (e, t) {
      h.console &&
        ...
        e &&
        Zn.test(e.name) &&
        h.console.warn('jQuery.Deferred exception: ' + e.message, e.stack, t);
    }),
      ...
      r.extend({
        ...
        ready: function (e) {
          (e === !0 ? --r.readyWait : r.isReady) ||
            ((r.isReady = !0), !(e !== !0 && --r.readyWait > 0) && Et.resolveWith(P, [r]));
        },
      }),
      (r.ready.then = Et.then));
    function ft() {
      (P.removeEventListener('DOMContentLoaded', ft), h.removeEventListener('load', ft), r.ready());
    }
    P.readyState === 'complete' || (P.readyState !== 'loading' && !P.documentElement.doScroll)
      ? h.setTimeout(r.ready)
      : (P.addEventListener('DOMContentLoaded', ft), h.addEventListener('load', ft));
    var we = function (e, t, n, i, o, s, a) {
        ...
        if (Ie(n) === 'object') {
          ...
          for (; l < f; l++) t(e[l], n, a ? i : i.call(e[l], l, t(e[l], n)));
      ...
      r.fn.extend({
        data: function (e, t) {
          var n,
            ...
            a = s && s.attributes;
          if (e === void 0) {
            if (this.length && ((o = ie.get(s)), s.nodeType === 1 && !D.get(s, 'hasDataAttrs'))) {
              for (n = a.length; n--; )
                a[n] &&
                  ((i = a[n].name),
                  i.indexOf('data-') === 0 && ((i = ge(i.slice(5))), en(s, i, o[i])));
              D.set(s, 'hasDataAttrs', !0);
            }
            return o;
          }
            ...
            : we(
                ...
                function (l) {
                  ...
                  if (s && l === void 0)
                    return (
                      (f = ie.get(s, e)),
                      f !== void 0 || ((f = en(s, e)), f !== void 0) ? f : void 0
                    );
                  this.each(function () {
                    ie.set(this, e, l);
                  });
      ...
      r.extend({
        queue: function (e, t, n) {
          ...
          if (e)
            return (
              (t = (t || 'fx') + 'queue'),
              (i = D.get(e, t)),
              n && (!i || Array.isArray(n) ? (i = D.access(e, t, r.makeArray(n))) : i.push(n)),
              i || []
            );
        },
        dequeue: function (e, t) {
          ...
          (o === 'inprogress' && ((o = n.shift()), i--),
            o && (t === 'fx' && n.unshift('inprogress'), delete s.stop, o.call(e, a, s)),
            !i && s && s.empty.fire());
        },
      ...
      r.fn.extend({
        ...
        promise: function (e, t) {
          ...
          for (typeof e != 'string' && ((t = e), (e = void 0)), e = e || 'fx'; a--; )
            ((n = D.get(s[a], e + 'queueHooks')), n && n.empty && (i++, n.empty.add(l)));
          return (l(), o.promise(t));
        },
      }));
    var tn = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
      Ke = new RegExp('^(?:([+-])=|)(' + tn + ')([a-z%]*)$', 'i'),
      Ee = ['Top', 'Right', 'Bottom', 'Left'],
      Le = P.documentElement,
      We = function (e) {
    ...
    Le.getRootNode &&
      (We = function (e) {
        return r.contains(e.ownerDocument, e) || e.getRootNode(si) === e.ownerDocument;
      });
    var lt = function (e, t) {
      return (
        (e = t || e),
        e.style.display === 'none' ||
          (e.style.display === '' && We(e) && r.css(e, 'display') === 'none')
      );
    };
    function nn(e, t, n, i) {
      var o,
        ...
        v = e.nodeType && (r.cssNumber[t] || (d !== 'px' && +f)) && Ke.exec(r.css(e, t));
      if (v && v[3] !== d) {
        for (f = f / 2, d = d || v[3], v = +f || 1; a--; )
          (r.style(e, t, v + d), (1 - s) * (1 - (s = l() / f || 0.5)) <= 0 && (a = 0), (v = v / s));
      ...
      for (var n, i, o = [], s = 0, a = e.length; s < a; s++)
        ((i = e[s]),
          i.style &&
            ...
            t
              ? (n === 'none' &&
                  ((o[s] = D.get(i, 'display') || null), o[s] || (i.style.display = '')),
                i.style.display === '' && lt(i) && (o[s] = ai(i)))
              : n !== 'none' && ((o[s] = 'none'), D.set(i, 'display', n))));
    ...
    (function () {
      ...
      (n.setAttribute('type', 'radio'),
        ...
        t.appendChild(n),
        (O.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked),
    ...
    ((ue.tbody = ue.tfoot = ue.colgroup = ue.caption = ue.thead),
      (ue.th = ue.td),
      O.option || (ue.optgroup = ue.option = [1, "<select multiple='multiple'>", '</select>']));
    function re(e, t) {
      var n;
      return (
    ...
    function an(e, t, n, i, o) {
      for (
        var s, a, l, f, d, v, b = t.createDocumentFragment(), g = [], x = 0, H = e.length;
        x < H;
        x++
      )
        if (((s = e[x]), s || s === 0))
      ...
      for (b.textContent = '', x = 0; (s = g[x++]); ) {
        ...
        if (((d = We(s)), (a = re(b.appendChild(s), 'script')), d && Nt(a), n))
          for (v = 0; (s = a[v++]); ) sn.test(s.type || '') && n.push(s);
      }
      return b;
    }
    var un = /^([^.]*)(?:\.(.+)|)/;
    ...
    function St(e, t, n, i, o, s) {
      ...
      if (
        (i == null && o == null
          ? ((o = n), (i = n = void 0))
          : o == null &&
            (typeof n == 'string' ? ((o = i), (i = void 0)) : ((o = i), (i = n), (n = void 0))),
        o === !1)
      )
        o = Be;
      else if (!o) return e;
    ...
    r.event = {
        ...
        if (Qe(e))
          for (
            n.handler && ((s = n), (n = s.handler), (o = s.selector)),
              ...
              (f = R.events) || (f = R.events = Object.create(null)),
              (a = R.handle) ||
                (a = R.handle =
                  function (Z) {
                    return typeof r < 'u' && r.event.triggered !== Z.type
            ...
            ((l = un.exec(t[d]) || []),
              ...
              x &&
                ...
                (g = f[x]) ||
                  ((g = f[x] = []),
                  (g.delegateCount = 0),
                  (!b.setup || b.setup.call(e, i, H, a) === !1) &&
                    e.addEventListener &&
                    e.addEventListener(x, a)),
                b.add && (b.add.call(e, v), v.handler.guid || (v.handler.guid = n.guid)),
      ...
      remove: function (e, t, n, i, o) {
        var s,
          ...
          H,
          B,
          R = D.hasData(e) && D.get(e);
        if (!(!R || !(f = R.events))) {
          for (t = (t || '').match(he) || [''], d = t.length; d--; ) {
            if (
              ((l = un.exec(t[d]) || []), (x = B = l[1]), (H = (l[2] || '').split('.').sort()), !x)
            ) {
            ...
            a &&
              !g.length &&
              ((!b.teardown || b.teardown.call(e, H, R.handle) === !1) &&
                r.removeEvent(e, x, R.handle),
              delete f[x]);
          }
          r.isEmptyObject(f) && D.remove(e, 'handle events');
        }
      },
      dispatch: function (e) {
        var t,
          ...
          v = r.event.special[f.type] || {};
        for (l[0] = f, t = 1; t < arguments.length; t++) l[t] = arguments[t];
        if (((f.delegateTarget = this), !(v.preDispatch && v.preDispatch.call(this, f) === !1))) {
          for (
            ...
            for (
              ...
              (!f.rnamespace || s.namespace === !1 || f.rnamespace.test(s.namespace)) &&
                ((f.handleObj = s),
                (f.data = s.data),
                (i = ((r.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, l)),
                i !== void 0 && (f.result = i) === !1 && (f.preventDefault(), f.stopPropagation()));
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            var t = this || e;
            return (Ze.test(t.type) && t.click && Q(t, 'input') && ct(t, 'click', !0), !1);
          },
          trigger: function (e) {
            var t = this || e;
            return (Ze.test(t.type) && t.click && Q(t, 'input') && ct(t, 'click'), !0);
          },
          _default: function (e) {
            var t = e.target;
            return (Ze.test(t.type) && t.click && Q(t, 'input') && D.get(t, 'click')) || Q(t, 'a');
          },
        },
        beforeunload: {
    ...
    function ct(e, t, n) {
      if (!n) {
        D.get(e, t) === void 0 && r.event.add(e, t, Ye);
        return;
      }
      (D.set(e, t, !1),
        r.event.add(e, t, {
          ...
          handler: function (i) {
            ...
            if (i.isTrigger & 1 && this[t]) {
              if (s) (r.event.special[t] || {}).delegateType && i.stopPropagation();
              else if (
                ((s = k.call(arguments)),
                D.set(this, t, s),
                this[t](),
              ...
              s &&
                (D.set(this, t, r.event.trigger(s[0], s.slice(1), this)),
                i.stopPropagation(),
        ...
        (e && e.type
          ? ((this.originalEvent = e),
            ...
            (this.isDefaultPrevented =
              e.defaultPrevented || (e.defaultPrevented === void 0 && e.returnValue === !1)
                ? Ye
                : Be),
      ...
      r.each({ focus: 'focusin', blur: 'focusout' }, function (e, t) {
        ...
        ((r.event.special[e] = {
          ...
          teardown: function () {
            ...
            if (P.documentMode)
              ((i = D.get(this, t) - 1),
                i ? D.set(this, t, i) : (this.removeEventListener(t, n), D.remove(this, t)));
            else return !1;
          },
          _default: function (i) {
          ...
          (r.event.special[t] = {
            setup: function () {
              var i = this.ownerDocument || this.document || this,
                ...
                s = D.get(o, t);
              (s || (P.documentMode ? this.addEventListener(t, n) : i.addEventListener(e, n, !0)),
                D.set(o, t, (s || 0) + 1));
            },
            teardown: function () {
              var i = this.ownerDocument || this.document || this,
            ...
            handle: function (n) {
              ...
              return (
                (!s || (s !== o && !r.contains(o, s))) &&
                  ((n.type = a.origType), (i = a.handler.apply(this, arguments)), (n.type = t)),
                i
              );
            },
          };
    ...
    function ln(e, t) {
      var n, i, o, s, a, l, f;
      if (t.nodeType === 1) {
        if (D.hasData(e) && ((s = D.get(e)), (f = s.events), f)) {
          D.remove(t, 'handle events');
          for (o in f) for (n = 0, i = f[o].length; n < i; n++) r.event.add(t, o, f[o][n]);
        }
        ie.hasData(e) && ((a = ie.access(e)), (l = r.extend({}, a)), ie.set(t, l));
      }
    }
    function hi(e, t) {
    ...
    function $e(e, t, n, i) {
      ...
      var o,
        ...
        x = t[0],
        H = M(x);
      if (H || (b > 1 && typeof x == 'string' && !O.checkClone && li.test(x)))
      ...
      if (
        ...
        for (a = r.map(re(o, 'script'), di), l = a.length; v < b; v++)
          ((f = o),
            v !== g && ((f = r.clone(f, !0, !0)), l && r.merge(a, re(f, 'script'))),
            n.call(e[v], f, v));
        if (l)
          for (d = a[a.length - 1].ownerDocument, r.map(a, pi), v = 0; v < l; v++)
            ((f = a[v]),
              sn.test(f.type || '') &&
                ...
                (f.src && (f.type || '').toLowerCase() !== 'module'
                  ? r._evalUrl &&
                    !f.noModule &&
                    r._evalUrl(f.src, { nonce: f.nonce || f.getAttribute('nonce') }, d)
    ...
    function cn(e, t, n) {
      for (var i, o = t ? r.filter(t, e) : e, s = 0; (i = o[s]) != null; s++)
        (!n && i.nodeType === 1 && r.cleanData(re(i)),
          i.parentNode && (n && We(i) && Nt(re(i, 'script')), i.parentNode.removeChild(i)));
      return e;
    }
    (r.extend({
      ...
      clone: function (e, t, n) {
        var i,
          ...
          l = e.cloneNode(!0),
          f = We(e);
        if (!O.noCloneChecked && (e.nodeType === 1 || e.nodeType === 11) && !r.isXMLDoc(e))
          for (a = re(l), s = re(e), i = 0, o = s.length; i < o; i++) hi(s[i], a[i]);
        if (t)
          if (n)
            for (s = s || re(e), a = a || re(l), i = 0, o = s.length; i < o; i++) ln(s[i], a[i]);
          else ln(e, l);
        return ((a = re(l, 'script')), a.length > 0 && Nt(a, !f && re(e, 'script')), l);
      },
      cleanData: function (e) {
        for (var t, n, i, o = r.event.special, s = 0; (n = e[s]) !== void 0; s++)
          if (Qe(n)) {
            if ((t = n[D.expando])) {
              if (t.events)
      ...
      r.fn.extend({
        ...
        empty: function () {
          for (var e, t = 0; (e = this[t]) != null; t++)
            e.nodeType === 1 && (r.cleanData(re(e, !1)), (e.textContent = ''));
          return this;
        },
        clone: function (e, t) {
          return (
            ...
            function (t) {
              ...
              if (
                ...
                try {
                  for (; i < o; i++)
                    ((n = this[i] || {}),
                      n.nodeType === 1 && (r.cleanData(re(n, !1)), (n.innerHTML = t)));
                  n = 0;
                } catch {}
              }
      ...
      r.each(
        ...
        function (e, t) {
          r.fn[e] = function (n) {
            for (var i, o = [], s = r(n), a = s.length - 1, l = 0; l <= a; l++)
              ((i = l === a ? this : this.clone(!0)), r(s[l])[t](i), I.apply(o, i.get()));
            return this.pushStack(o);
          };
        }
      ));
    var At = new RegExp('^(' + tn + ')(?!px)[a-z%]+$', 'i'),
      Dt = /^--/,
      dt = function (e) {
          ...
          reliableTrDimensions: function () {
            ...
            return (
              a == null &&
                ...
                (v.style.cssText = 'position:absolute;left:-11111px;border-collapse:separate'),
    ...
    var vi = /^(none|table(?!-c[ea]).+)/,
      mi = { position: 'absolute', visibility: 'hidden', display: 'block' },
    ...
    function jt(e, t, n, i, o, s) {
      ...
      for (; a < 4; a += 2)
        (n === 'margin' && (d += r.css(e, n + Ee[a], !0, o)),
          i
            ? (n === 'content' && (f -= r.css(e, 'padding' + Ee[a], !0, o)),
              n !== 'margin' && (f -= r.css(e, 'border' + Ee[a] + 'Width', !0, o)))
            : ((f += r.css(e, 'padding' + Ee[a], !0, o)),
              n !== 'padding'
                ? (f += r.css(e, 'border' + Ee[a] + 'Width', !0, o))
                : (l += r.css(e, 'border' + Ee[a] + 'Width', !0, o))));
      return (
        !i &&
          s >= 0 &&
          (f +=
            Math.max(
              0,
              Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - s - f - l - 0.5)
            ) || 0),
        f + d
      );
    }
    function bn(e, t, n) {
      ...
      return (
        ((!O.boxSizingReliable() && s) ||
          ...
          ((s = r.css(e, 'boxSizing', !1, i) === 'border-box'), (a = f in e), a && (l = e[f])),
        (l = parseFloat(l) || 0),
    ...
    (r.extend({
      ...
      style: function (e, t, n, i) {
        if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
          var o,
            ...
            f = Dt.test(t),
            d = e.style;
          if ((f || (t = kt(l)), (a = r.cssHooks[t] || r.cssHooks[l]), n !== void 0)) {
            if (
              ((s = typeof n),
              s === 'string' && (o = Ke.exec(n)) && o[1] && ((n = nn(e, t, o)), (s = 'number')),
              n == null || n !== n)
            )
              return;
            (s === 'number' && !f && (n += (o && o[3]) || (r.cssNumber[l] ? '' : 'px')),
              !O.clearCloneStyle && n === '' && t.indexOf('background') === 0 && (d[t] = 'inherit'),
              (!a || !('set' in a) || (n = a.set(e, n, i)) !== void 0) &&
                (f ? d.setProperty(t, n) : (d[t] = n)));
          } else return a && 'get' in a && (o = a.get(e, !1, i)) !== void 0 ? o : d[t];
        }
      },
      css: function (e, t, n, i) {
        ...
        return (
          ...
          n === '' || n ? ((s = parseFloat(o)), n === !0 || isFinite(s) ? s || 0 : o) : o
        );
      },
    }),
      r.each(['height', 'width'], function (e, t) {
        r.cssHooks[t] = {
          ...
          set: function (n, i, o) {
            var s,
              a = dt(n),
              l = !O.scrollboxSize() && a.position === 'absolute',
              f = l || o,
              d = f && r.css(n, 'boxSizing', !1, a) === 'border-box',
              v = o ? jt(n, t, o, d, a) : 0;
            return (
              d &&
                l &&
      ...
      r.each({ margin: '', padding: '', border: 'Width' }, function (e, t) {
        ((r.cssHooks[e + t] = {
          expand: function (n) {
            for (var i = 0, o = {}, s = typeof n == 'string' ? n.split(' ') : [n]; i < 4; i++)
          ...
          return we(
            ...
            function (n, i, o) {
              var s,
                ...
                f = 0;
              if (Array.isArray(i)) {
                for (s = dt(n), a = i.length; f < a; f++) l[i[f]] = r.css(n, i[f], !1, s);
                return l;
              }
        ...
        run: function (e) {
          ...
          return (
            this.options.duration
              ? (this.pos = t =
                  r.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration))
              : (this.pos = t = e),
      ...
      (oe.propHooks = {
        _default: {
          ...
          set: function (e) {
            r.fx.step[e.prop]
              ? r.fx.step[e.prop](e)
              : e.elem.nodeType === 1 && (r.cssHooks[e.prop] || e.elem.style[kt(e.prop)] != null)
    ...
    function Cn(e, t, n) {
      for (
        var i, o = (de.tweeners[t] || []).concat(de.tweeners['*']), s = 0, a = o.length;
        s < a;
        s++
      )
    ...
    function Ci(e, t, n) {
      ...
      for (i in t)
        if (((o = t[i]), bi.test(o))) {
          if ((delete t[i], (s = s || o === 'toggle'), o === (B ? 'hide' : 'show')))
      ...
      if (((f = !r.isEmptyObject(t)), !(!f && r.isEmptyObject(x)))) {
        (b &&
          ...
          v === 'none' &&
            (d
              ? (v = d)
              : (Fe([e], !0), (d = e.style.display || d), (v = r.css(e, 'display')), Fe([e]))),
        ...
        for (i in x)
          (f ||
            (R ? 'hidden' in R && (B = R.hidden) : (R = D.access(e, 'fxshow', { display: d })),
            s && (R.hidden = !B),
            B && Fe([e], !0),
            g.done(function () {
              (B || Fe([e]), D.remove(e, 'fxshow'));
              for (i in x) r.style(e, i, x[i]);
            })),
            (f = Cn(B ? R[i] : 0, i, g)),
            i in R || ((R[i] = f.start), B && ((f.end = f.start), (f.start = 0))));
      }
    }
    function Ti(e, t) {
      var n, i, o, s, a;
    ...
    function de(e, t, n) {
      var i,
        ...
        f = function () {
          ...
          return (
            ...
            H < 1 && R ? g : (R || l.notifyWith(e, [d, 1, 0]), l.resolveWith(e, [d]), !1)
          );
        },
        d = l.promise({
          elem: e,
          props: r.extend({}, t),
          opts: r.extend(!0, { specialEasing: {}, easing: r.easing._default }, n),
          ...
          createTween: function (b, g) {
            var x = r.Tween(e, d.opts, b, g, d.opts.specialEasing[b] || d.opts.easing);
          ...
          stop: function (b) {
            ...
            return (
              b ? (l.notifyWith(e, [d, 1, 0]), l.resolveWith(e, [d, b])) : l.rejectWith(e, [d, b]),
              this
            );
          },
        }),
      ...
      for (Ti(v, d.opts.specialEasing); s < a; s++)
        if (((i = de.prefilters[s].call(d, e, v, d.opts)), i))
          return (M(i.stop) && (r._queueHooks(d.elem, d.opts.queue).stop = i.stop.bind(i)), i);
      return (
        r.map(v, Cn, d),
    ...
    ((r.Animation = r.extend(de, {
      ...
      tweener: function (e, t) {
        ...
        for (var n, i = 0, o = e.length; i < o; i++)
          ((n = e[i]), (de.tweeners[n] = de.tweeners[n] || []), de.tweeners[n].unshift(t));
      },
      prefilters: [Ci],
      ...
      (r.speed = function (e, t, n) {
        ...
        return (
          ...
          (i.old = i.complete),
          (i.complete = function () {
            (M(i.old) && i.old.call(this), i.queue && r.dequeue(this, i.queue));
          }),
          i
        );
      }),
      r.fn.extend({
        fadeTo: function (e, t, n, i) {
          return this.filter(lt).css('opacity', 0).show().end().animate({ opacity: t }, e, n, i);
        },
        animate: function (e, t, n, i) {
          var o = r.isEmptyObject(e),
            s = r.speed(t, n, i),
            a = function () {
              var l = de(this, r.extend({}, e), s);
              (o || D.get(this, 'finish')) && l.stop(!0);
            };
        ...
        stop: function (e, t, n) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (s in l) l[s] && l[s].stop && xi.test(s) && i(l[s]);
              for (s = a.length; s--; )
                a[s].elem === this &&
                  (e == null || a[s].queue === e) &&
                  (a[s].anim.stop(n), (o = !1), a.splice(s, 1));
    ...
    (r.fn.extend({
      ...
      r.extend({
        attr: function (e, t, n) {
          ...
          if (!(s === 3 || s === 8 || s === 2)) {
            ...
            if (
              ((s !== 1 || !r.isXMLDoc(e)) &&
                (o = r.attrHooks[t.toLowerCase()] || (r.expr.match.bool.test(t) ? Tn : void 0)),
              n !== void 0)
            ) {
              if (n === null) {
                r.removeAttr(e, t);
        ...
        attrHooks: {
          type: {
            set: function (e, t) {
              if (!O.radioValue && t === 'radio' && Q(e, 'input')) {
                var n = e.value;
      ...
      r.each(r.expr.match.bool.source.match(/\w+/g), function (e, t) {
        var n = tt[t] || r.find.attr;
        tt[t] = function (i, o, s) {
          var a,
            l,
            f = o.toLowerCase();
          return (
            s || ((l = tt[f]), (tt[f] = a), (a = n(i, o, s) != null ? f : null), (tt[f] = l)),
            a
          );
        };
      }));
    ...
    (r.fn.extend({
      ...
      r.extend({
        prop: function (e, t, n) {
          ...
          if (!(s === 3 || s === 8 || s === 2))
            return (
              (s !== 1 || !r.isXMLDoc(e)) && ((t = r.propFix[t] || t), (o = r.propHooks[t])),
              n !== void 0
        ...
        propHooks: {
          tabIndex: {
            get: function (e) {
              ...
              return t
                ? parseInt(t, 10)
                : wi.test(e.nodeName) || (Ei.test(e.nodeName) && e.href)
                  ? 0
                  : -1;
            },
          },
      ...
      addClass: function (e) {
        ...
        return M(e)
          ...
          : ((t = Ht(e)),
            t.length
              ? this.each(function () {
                  if (((i = qe(this)), (n = this.nodeType === 1 && ' ' + He(i) + ' '), n)) {
                    for (s = 0; s < t.length; s++)
                      ((o = t[s]), n.indexOf(' ' + o + ' ') < 0 && (n += o + ' '));
                    ((a = He(n)), i !== a && this.setAttribute('class', a));
                  }
                })
              : this);
      },
            ...
            : ((n = Ht(e)),
              this.each(function () {
                if (l)
                  ...
                  (e === void 0 || a === 'boolean') &&
                    ((i = qe(this)),
                    i && D.set(this, '__className__', i),
                    this.setAttribute &&
                      this.setAttribute(
                        'class',
                        i || e === !1 ? '' : D.get(this, '__className__') || ''
                      ));
              }));
      },
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = ' ' + e + ' '; (n = this[i++]); )
          if (n.nodeType === 1 && (' ' + He(qe(n)) + ' ').indexOf(t) > -1) return !0;
        return !1;
      },
    });
    var Ni = /\r/g;
        ...
        return arguments.length
          ? ((i = M(e)),
            this.each(function (s) {
              var a;
              this.nodeType === 1 &&
                (i ? (a = e.call(this, s, r(this).val())) : (a = e),
                a == null
                  ? (a = '')
                  : typeof a == 'number'
                    ? (a += '')
          ...
          : o
            ? ((t = r.valHooks[o.type] || r.valHooks[o.nodeName.toLowerCase()]),
              t && 'get' in t && (n = t.get(o, 'value')) !== void 0
                ? n
                : ((n = o.value), typeof n == 'string' ? n.replace(Ni, '') : (n ?? '')))
            : void 0;
      },
    }),
      r.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (e, t) {
              for (var n, i, o = e.options, s = r.makeArray(t), a = o.length; a--; )
                ((i = o[a]),
                  (i.selected = r.inArray(r.valHooks.option.get(i), s) > -1) && (n = !0));
...
`)
    ...
    var En = /^(?:focusinfocus|focusoutblur)$/,
      Nn = function (e) {
        e.stopPropagation();
      };
    (r.extend(r.event, {
      trigger: function (e, t, n, i) {
        ...
        if (
          ...
          !(n.nodeType === 3 || n.nodeType === 8) &&
            ...
            (x.indexOf('.') > -1 && ((H = x.split('.')), (x = H.shift()), H.sort()),
            (f = x.indexOf(':') < 0 && 'on' + x),
            (e = e[r.expando] ? e : new r.Event(x, typeof e == 'object' && e)),
            (e.isTrigger = i ? 2 : 3),
            (e.namespace = H.join('.')),
          ...
          if (!i && !v.noBubble && !Re(n)) {
            for (l = v.delegateType || x, En.test(l + x) || (s = s.parentNode); s; s = s.parentNode)
              (g.push(s), (a = s));
            a === (n.ownerDocument || P) && g.push(a.defaultView || a.parentWindow || h);
          }
          for (o = 0; (s = g[o++]) && !e.isPropagationStopped(); )
            ((b = s),
              (e.type = o > 1 ? l : v.bindType || x),
              (d = (D.get(s, 'events') || Object.create(null))[e.type] && D.get(s, 'handle')),
              d && d.apply(s, t),
              (d = f && s[f]),
              d &&
                d.apply &&
                Qe(s) &&
                ((e.result = d.apply(s, t)), e.result === !1 && e.preventDefault()));
          return (
            (e.type = x),
            !i &&
              ...
              a && (n[f] = null),
              (r.event.triggered = x),
              e.isPropagationStopped() && b.addEventListener(x, Nn),
              n[x](),
              e.isPropagationStopped() && b.removeEventListener(x, Nn),
    ...
    function Pt(e, t, n, i) {
      ...
      if (Array.isArray(t))
        r.each(t, function (s, a) {
          n || Si.test(e)
            ? i(e, a)
            : Pt(e + '[' + (typeof a == 'object' && a != null ? s : '') + ']', a, n, i);
        });
      else if (!n && Ie(t) === 'object') for (o in t) Pt(e + '[' + o + ']', t[o], n, i);
      else i(e, t);
    }
    ((r.param = function (e, t) {
      var n,
        ...
        o = function (s, a) {
          var l = M(a) ? a() : a;
          i[i.length] = encodeURIComponent(s) + '=' + encodeURIComponent(l ?? '');
        };
      if (e == null) return '';
...
`
    ...
    var ki = /%20/g,
      ...
      Li = /([?&])_=[^&]*/,
      Hi = /^(.*?):[ \t]*([^\r\n]*)$/gm,
      qi = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/,
      Pi = /^(?:GET|HEAD)$/,
      Oi = /^\/\//,
      An = {},
      Ot = {},
      ...
      function a(l) {
        ...
        return (
          ...
          r.each(e[l] || [], function (d, v) {
            var b = v(t, n, i);
            if (typeof b == 'string' && !s && !o[b]) return (t.dataTypes.unshift(b), a(b), !1);
            if (s) return !(f = b);
          }),
          f
        );
    ...
    function Mi(e, t, n) {
      for (var i, o, s, a, l = e.contents, f = e.dataTypes; f[0] === '*'; )
    ...
    function Ri(e, t, n, i) {
      var o,
        ...
        d = {},
        v = e.dataTypes.slice();
      if (v[1]) for (a in e.converters) d[a.toLowerCase()] = e.converters[a];
      for (s = v.shift(); s; )
        if (
          ...
          if (s === '*') s = f;
            ...
            if (((a = d[f + ' ' + s] || d['* ' + s]), !a)) {
              for (o in d)
                if (
                  ((l = o.split(' ')), l[1] === s && ((a = d[f + ' ' + l[0]] || d['* ' + l[0]]), a))
                ) {
                  a === !0 ? (a = d[o]) : d[o] !== !0 && ((s = l[0]), v.unshift(l[1]));
                  break;
                }
            }
            if (a !== !0)
              if (a && e.throws) t = a(t);
                ...
                try {
                  ...
                  return {
                    state: 'parsererror',
                    error: a ? b : 'No conversion from ' + f + ' to ' + s,
                  };
                }
          }
        }
    ...
    (r.extend({
      ...
      ajax: function (e, t) {
        ...
        var n,
          ...
          g = r.ajaxSetup({}, t),
          x = g.context || g,
          H = g.context && (x.nodeType || x.jquery) ? r(x) : r.event,
          B = r.Deferred(),
          ...
          F = {
            ...
            getResponseHeader: function ($) {
              ...
              if (f) {
                if (!s)
                  for (s = {}; (J = Hi.exec(o)); )
                    s[J[1].toLowerCase() + ' '] = (s[J[1].toLowerCase() + ' '] || []).concat(J[2]);
                J = s[$.toLowerCase() + ' '];
              }
            ...
            setRequestHeader: function ($, J) {
              return (
                f == null && (($ = ye[$.toLowerCase()] = ye[$.toLowerCase()] || $), (K[$] = J)),
                this
              );
            },
        ...
        if (
          (B.promise(F),
          (g.url = ((e || g.url || nt.href) + '').replace(Oi, nt.protocol + '//')),
          ...
          try {
            ((l.href = g.url),
              (l.href = l.href),
              (g.crossDomain = Mt.protocol + '//' + Mt.host != l.protocol + '//' + l.host));
          } catch {
            g.crossDomain = !0;
          }
        }
        ...
        ((d = r.event && g.global),
          ...
          g.hasContent
            ? g.data &&
              g.processData &&
              (g.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 &&
              (g.data = g.data.replace(ki, '+'))
            : ((b = g.url.slice(i.length)),
              g.data &&
                (g.processData || typeof g.data == 'string') &&
                ((i += (qt.test(i) ? '&' : '?') + g.data), delete g.data),
              g.cache === !1 &&
                ((i = i.replace(Li, '$1')), (b = (qt.test(i) ? '&' : '?') + '_=' + wn.guid++ + b)),
              (g.url = i + b)),
          g.ifModified &&
            (r.lastModified[i] && F.setRequestHeader('If-Modified-Since', r.lastModified[i]),
            r.etag[i] && F.setRequestHeader('If-None-Match', r.etag[i])),
          ((g.data && g.hasContent && g.contentType !== !1) || t.contentType) &&
            F.setRequestHeader('Content-Type', g.contentType),
          F.setRequestHeader(
            'Accept',
            g.dataTypes[0] && g.accepts[g.dataTypes[0]]
              ? g.accepts[g.dataTypes[0]] + (g.dataTypes[0] !== '*' ? ', ' + Dn + '; q=0.01' : '')
              : g.accepts['*']
          ));
        for (v in g.headers) F.setRequestHeader(v, g.headers[v]);
        if (g.beforeSend && (g.beforeSend.call(x, F, g) === !1 || f)) return F.abort();
        if (
          ((ve = 'abort'),
          R.add(g.complete),
          F.done(g.success),
          ...
          if (((F.readyState = 1), d && H.trigger('ajaxSend', [F, g]), f)) return F;
          g.async &&
            g.timeout > 0 &&
            ...
            me
              ? (g.ifModified &&
                ...
                $ === 204 || g.type === 'HEAD'
                  ...
                  : $ === 304
                    ? (fe = 'notmodified')
                    : ((fe = De.state), (ot = De.data), (be = De.error), (me = !be)))
              : ((be = fe), ($ || !fe) && ((fe = 'error'), $ < 0 && ($ = 0))),
            (F.status = $),
            (F.statusText = (J || fe) + ''),
            me ? B.resolveWith(x, [ot, fe, F]) : B.rejectWith(x, [F, fe, be]),
            F.statusCode(Z),
            (Z = void 0),
            d && H.trigger(me ? 'ajaxSuccess' : 'ajaxError', [F, g, me ? ot : be]),
            R.fireWith(x, [F, fe]),
            d && (H.trigger('ajaxComplete', [F, g]), --r.active || r.event.trigger('ajaxStop')));
        }
        return F;
      },
    ...
    (r.ajaxSetup({
      ...
      jsonpCallback: function () {
        var e = Ln.pop() || r.expando + '_' + wn.guid++;
        return ((this[e] = !0), e);
      },
    }),
        ...
        if (a || e.dataTypes[0] === 'jsonp')
          return (
            ...
            a
              ...
              : e.jsonp !== !1 && (e.url += (qt.test(e.url) ? '&' : '?') + e.jsonp + '=' + i),
      ...
      (r.parseHTML = function (e, t, n) {
        ...
        return (
          ...
          o
            ? [t.createElement(o[1])]
            : ((o = an([e], t, s)), s && s.length && r(s).remove(), r.merge([], o.childNodes))
        );
      }),
      (r.fn.load = function (e, t, n) {
        ...
        return (
          ...
          M(t) ? ((n = t), (t = void 0)) : t && typeof t == 'object' && (o = 'POST'),
          a.length > 0 &&
            r
              .ajax({ url: e, type: o || 'GET', dataType: 'html', data: t })
              .done(function (f) {
                ((s = arguments), a.html(i ? r('<div>').append(r.parseHTML(f)).find(i) : f));
              })
              .always(
                n &&
                  function (f, d) {
      ...
      (r.offset = {
        setOffset: function (e, t, n) {
          ...
          (v === 'static' && (e.style.position = 'relative'),
            ...
            (s = r.css(e, 'top')),
            (f = r.css(e, 'left')),
            (d = (v === 'absolute' || v === 'fixed') && (s + f).indexOf('auto') > -1),
            d
              ? ((i = b.position()), (a = i.top), (o = i.left))
              : ((a = parseFloat(s) || 0), (o = parseFloat(f) || 0)),
          ...
          if (this[0]) {
            ...
            if (r.css(i, 'position') === 'fixed') t = i.getBoundingClientRect();
              ...
              for (
                ...
                e && (e === n.body || e === n.documentElement) && r.css(e, 'position') === 'static';
              )
                e = e.parentNode;
              e &&
                e !== i &&
      ...
      r.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function (e, t) {
        ...
        r.fn[e] = function (i) {
          return we(
            ...
            function (o, s, a) {
              var l;
              if ((Re(o) ? (l = o) : o.nodeType === 9 && (l = o.defaultView), a === void 0))
                return l ? l[t] : o[s];
              l ? l.scrollTo(n ? l.pageXOffset : a, n ? a : l.pageYOffset) : (o[s] = a);
            },
            e,
            i,
            arguments.length
      ...
      r.each(['top', 'left'], function (e, t) {
        r.cssHooks[t] = pn(O.pixelPosition, function (n, i) {
          if (i) return ((i = et(n, t)), At.test(i) ? r(n).position()[t] + 'px' : i);
        });
      }),
      r.each({ Height: 'height', Width: 'width' }, function (e, t) {
        r.each({ padding: 'inner' + e, content: t, '': 'outer' + e }, function (n, i) {
          r.fn[i] = function (o, s) {
            var a = arguments.length && (n || typeof o != 'boolean'),
              l = n || (o === !0 || s === !0 ? 'margin' : 'border');
            return we(
              this,
              function (f, d, v) {
                var b;
    ...
    return (
      (r.noConflict = function (e) {
        return (h.$ === r && (h.$ = Wi), e && h.jQuery === r && (h.jQuery = _i), r);
      }),
...
var sr = Mn(at(), 1),
  G = at();
var nr = 'ontouchstart' in document,
  In = document.dir == 'rtl',
  Xn = (function () {
    var h = document.createElement('div'),
      N = document.documentElement;
    if (!('pointerEvents' in h.style)) return !1;
    ((h.style.pointerEvents = 'auto'), (h.style.pointerEvents = 'x'), N.appendChild(h));
    var S = window.getComputedStyle && window.getComputedStyle(h, '').pointerEvents === 'auto';
    return (N.removeChild(h), !!S);
  })(),
  ir = {
    listNodeName: 'ol',
    itemNodeName: 'li',
...
function _n(h, N) {
  ((this.w = G(document)), (this.el = G(h)), (this.options = G.extend({}, ir, N)), this.init());
}
_n.prototype = {
  init: function () {
    var h = this;
    (h.reset(),
      ...
      h.el.on('click', 'button', function (k) {
        if (!h.dragEl) {
          var W = G(k.currentTarget),
            I = W.data('action'),
            E = W.parent(h.options.itemNodeName);
          (I === 'collapse' && h.collapseItem(E), I === 'expand' && h.expandItem(E));
        }
      }));
    var N = function (k) {
        var W = G(k.target);
        ...
        !W.length ||
          ...
          !(h.isTouch && k.touches.length !== 1) &&
            (k.preventDefault(), h.dragStart(k.touches ? k.touches[0] : k)));
      },
      S = function (k) {
        h.dragEl && (k.preventDefault(), h.dragMove(k.touches ? k.touches[0] : k));
      },
      Y = function (k) {
        h.dragEl && (k.preventDefault(), h.dragStop(k.touches ? k.touches[0] : k));
      };
    (nr &&
  ...
  serialize: function () {
    ...
    let Y = function (k, W) {
      var I = [],
        E = k.children(S.options.itemNodeName);
      return (
        E.each(function () {
          var ce = G(this),
            Ce = G.extend({}, ce.data()),
            ae = ce.children(S.options.listNodeName);
          (ae.length && (Ce.children = Y(ae, W + 1)), I.push(Ce));
        }),
        I
      );
    };
    return ((h = Y(S.el.find(S.options.listNodeName).first(), N)), h);
  },
  serialise: function () {
  ...
  collapseItem: function (h) {
    var N = h.children(this.options.listNodeName);
    N.length &&
  ...
  setParent: function (h) {
    (h.children(this.options.listNodeName).length &&
      (h.prepend(G(this.options.expandBtnHTML)), h.prepend(G(this.options.collapseBtnHTML))),
      h.children('[data-action="expand"]').hide());
  },
  ...
  dragStart: function (h) {
    var N = this.mouse,
      S = G(h.target),
      Y = S.closest(this.options.itemNodeName);
    (this.placeEl.css('height', Y.height()),
      (N.offsetX = h.offsetX !== void 0 ? h.offsetX : h.pageX - S.offset().left),
      (N.offsetY = h.offsetY !== void 0 ? h.offsetY : h.pageY - S.offset().top),
      (N.startX = N.lastX = h.pageX),
      (N.startY = N.lastY = h.pageY),
      (this.dragRootEl = this.el),
      (this.dragEl = G(document.createElement(this.options.listNodeName)).addClass(
      ...
      In
        ...
        : this.dragEl.css({ left: h.pageX - N.offsetX, top: h.pageY - N.offsetY }));
    var k,
      W,
  ...
  dragStop: function (h) {
    var N = this.dragEl.children(this.options.itemNodeName).first();
  ...
  dragMove: function (h) {
    ...
    (In
      ...
      : this.dragEl.css({ left: h.pageX - E.offsetX, top: h.pageY - E.offsetY }),
      (E.lastX = E.nowX),
      (E.lastY = E.nowY),
      (E.nowX = h.pageX),
      (E.nowY = h.pageY),
    ...
    var ce = Math.abs(E.distX) > Math.abs(E.distY) ? 1 : 0;
    if (!E.moving) {
      ...
      E.dirAx &&
        ...
        E.distX > 0 &&
          ...
          W + this.dragDepth <= I.maxDepth &&
            (N.length
              ? ((N = Y.children(I.listNodeName).last()), N.append(this.placeEl))
              : ((N = G('<' + I.listNodeName + '/>').addClass(I.listClass)),
        ...
        E.distX < 0 &&
          ...
          k.length ||
            ((S = this.placeEl.parent()),
            this.placeEl.closest(I.itemNodeName).after(this.placeEl),
            S.children().length || this.unsetParent(S.parent())))));
    var Ce = !1;
    if (
      ...
      (this.pointEl = G(
        document.elementFromPoint(
          ...
          h.pageY - (window.pageYOffset || document.documentElement.scrollTop)
        )
      )),
    ...
    var ae = this.pointEl.closest('.' + I.rootClass),
      Me = this.dragRootEl.data('nestable-id') !== ae.data('nestable-id');
    if (!E.dirAx || Me || Ce) {
      if (
        (Me && I.group !== ae.data('nestable-group')) ||
        ((W = this.dragDepth - 1 + this.pointEl.parents(I.listNodeName).length), W > I.maxDepth)
      )
        return;
      var xt = h.pageY < this.pointEl.offset().top + this.pointEl.height() / 2;
      ((S = this.placeEl.parent()),
        Ce
          ? ((N = G(document.createElement(I.listNodeName)).addClass(I.listClass)),
            N.append(this.placeEl),
        ...
        Me && ((this.dragRootEl = ae), (this.hasNewRoot = this.el[0] !== this.dragRootEl[0])));
    }
  },
};
var Ae = class {
  constructor() {}
  static buildNestable(N, S) {
    var Y = N,
      k = N;
    return (
      Y.each(function () {
        var W = G(N).data('nestable');
        W
          ? typeof S == 'string' && typeof W[S] == 'function' && (k = W[S]())
          : (G(N).data('nestable', new _n(N, S)), G(N).data('nestable-id', new Date().getTime()));
      }),
      k || Y
    );
  }
...
function rr({ containerKey: h, maxDepth: N }) {
  return {
    ...
    nestedTree: null,
    init: function () {
      let S = ne(this.containerKey);
      this.nestedTreeElement = S;
      let Y = this.compile(this.nestedTreeElement, {
        group: h,
        maxDepth: N,
        expandBtnHTML: '',
        collapseBtnHTML: '',
      ...
      ((this.nestedTree = Y),
        this.nestedTreeElement.on('click', '.dd-item-btns [data-action=expand]', function (k) {
          let W = ne(this).closest('li');
          W.length &&
            (ne(this).addClass('hidden'),
            ne(this)
              .parent()
              .children('.dd-item-btns [data-action=collapse]')
              .removeClass('hidden'),
            W.find('> .dd-list').removeClass('hidden').show(),
            W.find('> .dd-list > .dd-item').removeClass('dd-collapsed hidden'));
        }),
        this.nestedTreeElement.on('click', '.dd-item-btns [data-action=collapse]', function (k) {
          let W = ne(this).closest('li');
          W.length &&
            (ne(this).addClass('hidden'),
            ne(this).parent().children('.dd-item-btns [data-action=expand]').removeClass('hidden'),
            W.find('> .dd-list').addClass('hidden').hide(),
            W.find('> .dd-list > .dd-item').addClass('dd-collapsed hidden'));
        }));
    },
    compile: function (S, Y) {
      return Ae.buildNestable(S, Y);
    },
    save: async function () {
      let S = Ae.buildNestable(this.nestedTree, 'serialize');
      (await this.$wire.updateTree(S)).reload === !0 && Ae.buildNestable(this.nestedTree, 'reset');
    },
    collapseAll: function () {
      let S = this.$refs.treeContainer;
      S &&
        (Ae.buildNestable(ne(S), 'collapseAll'),
        ne(S).find('.dd-item-btns [data-action=expand]').removeClass('hidden'),
        ne(S).find('.dd-item-btns [data-action=collapse]').addClass('hidden'),
        ne(S).find('ol > li').find('li').addClass('hidden'));
    },
    expandAll: function () {
      let S = this.$refs.treeContainer;
      S &&
        (Ae.buildNestable(ne(S), 'expandAll'),
        ne(S).find('.dd-item-btns [data-action=expand]').addClass('hidden'),
        ne(S).find('.dd-item-btns [data-action=collapse]').removeClass('hidden'),
        ne(S).find('ol > li').find('li').removeClass('hidden'));
    },
  };
}

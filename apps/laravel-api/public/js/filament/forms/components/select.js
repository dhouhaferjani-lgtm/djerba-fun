      ...
      var se = {
                ...
                return (
                  ...
                  (g.prototype._onDirectionKey = function (e, t) {
                    ...
                    if (t || this._isSelectOneElement) {
                      ...
                      if (f)
                        K > 0
                          ? (C = this.dropdown.element.querySelector(''.concat(u, ':last-of-type')))
          ...
          799: function (j, i) {
            ...
            var c = function (E, w, N) {
              N === void 0 && (N = 1);
              for (
                var g = ''.concat(N > 0 ? 'next' : 'previous', 'ElementSibling'), e = E[g];
                e;
              ) {
          ...
          996: function (j) {
            ...
            function k(E, w) {
              return (
                D(E, w) &&
                !(Object.hasOwnProperty.call(E, w) && Object.propertyIsEnumerable.call(E, w))
              );
            }
            function Q(E, w, N) {
              var g = {};

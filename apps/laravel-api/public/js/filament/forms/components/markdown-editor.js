...
var Ed = (o, p, v, C) => {
  if ((p && typeof p == 'object') || typeof p == 'function')
    for (let b of Td(p))
      !Ld.call(o, b) &&
        b !== v &&
        ss(o, b, { get: () => p[b], enumerable: !(C = Sd(p, b)) || C.enumerable });
  return o;
};
            ...
            ((n.state = !0),
              va(
                ...
                function (Y, ie) {
                  for (var ue = j; ee < Y; ) {
                    var me = i[j];
                    (me > Y && i.splice(j, 1, Y, i[j + 1], me), (j += 2), (ee = Math.min(Y, me)));
                  }
                  if (ie)
                    if (A.opaque) (i.splice(ue, j - ue, Y, 'overlay ' + ie), (j = ue + 2));
                    else
                      for (; ue < j; ue += 2) {
                        var ve = i[ue + 1];
      ...
      for (t == '' && ma(pa(n, r.state), a); !A.eol(); ) {
        if (
          (A.pos > e.options.maxHighlightLength
            ? ((u = !1), l && ro(e, t, r, A.pos), (A.pos = t.length), (j = null))
        ...
        for (var l = r[a], u = l.find(0), f = 0; f < i.length; ++f) {
          ...
          if (!(ye(m.to, u.from) < 0 || ye(m.from, u.to) > 0)) {
            var A = [f, 1],
              j = ye(m.from, u.from),
              ee = ye(m.to, u.to);
            ((j < 0 || (!l.inclusiveLeft && !j)) && A.push({ from: m.from, to: u.from }),
...
`
                ...
                : ((ue = e.cm.options.specialCharPlaceholder(ee[0])),
                  ue.setAttribute('cm-text', ee[0]),
                  s && h < 9 ? A.appendChild(x('span', [ue])) : A.appendChild(ue),
                  (e.col += 1));
    ...
    function $c(e, t, n) {
      ...
      for (var u = i.length, f = 0, m = 1, A = '', j, ee, Y = 0, ie, ue, me, ve, _e; ; ) {
        if (Y == f) {
        ...
        for (var Ot = Math.min(u, Y); ; ) {
          if (A) {
            ...
            if (!ve) {
              ...
              t.addToken(t, ut, j ? j + ie : ie, me, f + ut.length == Y ? ue : '', ee, _e);
            }
            if (At >= Ot) {
              ((A = A.slice(Ot - f)), (f = Ot));
              break;
    ...
    function of(e, t, n, r) {
      ...
      if (a.nodeType == 3) {
        for (var A = 0; A < 4; A++) {
          ...
          for (; i.coverStart + u < i.coverEnd && B(t.line.text.charAt(i.coverStart + u)); ) ++u;
          if (
    ...
    function lf(e, t, n, r, i) {
      ...
      if (A) {
        ...
        ((m = j.level != 1), (u = m ? j.from : j.to - 1), (f = m ? j.to : j.from - 1));
      }
      var ee = null,
        Y = null,
        ie = De(
    ...
    function Vr(e) {
      ...
      if (zr == null) {
        ...
        for (var t = 0; t < 49; ++t)
          (zr.appendChild(document.createTextNode('x')), zr.appendChild(x('br')));
    ...
    function pf(e, t, n, r) {
      ...
      for (var a = 0; a < 5; a++) {
        ...
        if (
          ...
          m.scrollLeft != null &&
            (Dr(e, m.scrollLeft), Math.abs(e.doc.scrollLeft - j) > 1 && (l = !0)),
          !l)
        )
          break;
      }
    ...
    function To(e, t) {
      ...
      var j = e.options.fixedGutter ? 0 : n.gutters.offsetWidth,
        ee = e.curOp && e.curOp.scrollLeft != null ? e.curOp.scrollLeft : n.scroller.scrollLeft - j,
      ...
      for (var f = r.view, m = r.viewFrom, A = 0; A < f.length; A++) {
        ...
        if (!j.hidden)
          if (!j.node || j.node.parentNode != a) {
            ...
            (j.changes && (Se(j.changes, 'gutter') > -1 && (Y = !1), Ma(e, j, m, n)),
              Y &&
                (R(j.lineNumber),
                j.lineNumber.appendChild(document.createTextNode(he(e.options, m)))),
    ...
    function al(e) {
      ...
      if (n.length != r.lineNumChars) {
        var i = r.measure.appendChild(
            x('div', [x('div', n)], 'CodeMirror-linenumber CodeMirror-gutter-elt')
          ),
    ...
    function Fo(e, t, n, r) {
      ...
      if (t.full) (e.insert(0, l(0, m.length)), e.remove(m.length, e.size - m.length));
        ...
        (a(j, j.text, Y), ie && e.remove(u.line, ie), ue.length && e.insert(u.line, ue));
      } else if (A == j)
        ...
        (a(A, A.text.slice(0, u.ch) + m[0] + j.text.slice(f.ch), i(0)), e.remove(u.line + 1, ie));
      else {
        (a(A, A.text.slice(0, u.ch) + m[0], i(0)), a(j, ee + j.text.slice(f.ch), Y));
          ...
          if (
            ...
            if (n) {
              var j = f.find(r < 0 ? 1 : -1),
                ee = void 0;
              if (
                ((r < 0 ? A : m) && (j = Tl(e, j, -r, j && j.line == t.line ? a : null)),
                j && j.line == t.line && (ee = ye(j, n)) && (r < 0 ? ee < 0 : ee > 0))
              )
                return on(e, j, t, r, i);
            }
    ...
    function an(e, t, n) {
      ...
      if (
        !((It(e, 'beforeChange') || (e.cm && It(e.cm, 'beforeChange'))) && ((t = Cl(e, t, !0)), !t))
      ) {
        ...
        if (m != u.length) {
          ...
          for (
            var j = It(e, 'beforeChange') || (e.cm && It(e.cm, 'beforeChange')),
              ee = function (ue) {
                var me = a.changes[ue];
                if (((me.origin = t), j && !Cl(e, me, !1))) return ((u.length = 0), {});
                A.push(Io(e, me));
    ...
    function sn(e, t, n, r, i) {
      ...
      if (
        (e.iter(u, n.line + 1, function (j) {
          (f && a.collapsed && !f.options.lineWrapping && Zt(j) == f.display.maxLine && (m = !0),
...
`
          ...
          if (r && r.length && window.FileReader && window.File)
            ...
            try {
              ...
              if (A) {
                var j;
                if (
                  (t.state.draggingText && !t.state.draggingText.copy && (j = t.listSelections()),
                  ki(t.doc, yr(n, n)),
                  j)
                )
                  for (var ee = 0; ee < j.length; ++ee)
    ...
    function Vf(e, t, n, r) {
      ...
      if (e.doc.direction == 'rtl' || l.level == 1) {
        var j = (l.level == 1) == r < 0,
          ee = u(n, j ? 1 : -1);
        if (ee != null && (j ? ee <= l.to && ee <= A.end : ee >= l.from && ee >= A.begin)) {
...
`,
    ...
    function Xl(e) {
      ...
      if (
        !(e.target && e.target != t.display.input.getField()) &&
        !(lr(t.display, e) || ot(t, e) || (e.ctrlKey && !e.altKey) || (O && e.metaKey))
      ) {
        var n = e.keyCode,
          r = e.charCode;
        if (d && n == Ho) {
    ...
    function Xn(e, t, n, r) {
      ...
      var j = '',
        ee = 0;
      if (e.options.indentWithTabs) for (var Y = Math.floor(A / l); Y; --Y) ((ee += l), (j += '	'));
      if ((ee < A && (j += Z(A - ee)), j != m))
        return (ln(i, j, ne(t, 0), ne(t, m.length), '+input'), (u.stateAfter = null), !0);
...
`) == t
      ...
      for (var j = e.curOp.updateInput, ee = r.ranges.length - 1; ee >= 0; ee--) {
        var Y = r.ranges[ee],
          ie = Y.from(),
          ue = Y.to();
        Y.empty() &&
...
`) &&
      ...
      ((e.prototype = {
        ...
        addWidget: function (r, i, a, l, u) {
          ...
          if (
            ...
            ((l == 'above' || r.bottom + i.offsetHeight > j) && r.top > i.offsetHeight
        ...
        findPosV: function (r, i, a, l) {
          ...
          for (var m = Re(this.doc, r), A = 0; A < i; ++A) {
            var j = Xt(this, m, 'div');
            if ((f == null ? (f = j.left) : (j.left = f), (m = as(this, j, u, a)), m.hitSide))
              break;
          }
          return m;
        },
        moveV: Tt(function (r, i) {
          ...
          if (
            (l.extendSelectionsBy(function (A) {
              ...
              var ee = as(a, j, r, i);
              return (
                i == 'page' && A == l.sel.primary() && Lo(a, fi(a, ee, 'div').top - j.top),
                ee
              );
            }, He),
            u.length)
    ...
    function Go(e, t, n, r, i) {
      ...
      if (r == 'char' || r == 'codepoint') A();
        ...
        for (
          var j = null, ee = r == 'group', Y = e.cm && e.cm.getHelper(t, 'wordChars'), ie = !0;
          !(n < 0 && !A(!ie));
          ie = !1
        ) {
          var ue =
...
`)));
      ...
      (Qe.prototype.showPrimarySelection = function () {
        ...
        if (!(a && !a.bad && l && !l.bad && ye(Zr(a, l), r) == 0 && ye(Et(a, l), i) == 0)) {
          ...
          if (!m) {
            ...
            m = { node: j[j.length - 1], offset: j[j.length - 2] - j[j.length - 3] };
          }
          if (!f || !m) {
            e.removeAllRanges();
            return;
      ...
      (Qe.prototype.pollSelection = function () {
        if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
          var e = this.getSelection(),
            t = this.cm;
          if (W && y && this.cm.display.gutterSpecs.length && bd(e.anchorNode)) {
      ...
      (Qe.prototype.pollContent = function () {
        ...
        for (
          var Y = 0, ie = 0, ue = j[0], me = ee[0], ve = Math.min(ue.length, me.length);
        ...
        if (j.length == 1 && ee.length == 1 && l == r.line)
          for (
            ;
            Y && Y > r.ch && _e.charCodeAt(_e.length - ie - 1) == be.charCodeAt(be.length - ie - 1);
          )
            (Y--, ie++);
        ((j[j.length - 1] = _e.slice(0, _e.length - ie).replace(/^\u200b+/, '')),
          (j[0] = j[0].slice(Y).replace(/\u200b+$/, '')));
        var Ne = ne(l, Y),
          Fe = ne(m, ee.length ? ce(ee).length - ie : 0);
        if (j.length > 1 || j[0] || ye(Ne, Fe)) return (ln(e.doc, j, Ne, Fe, '+input'), !0);
      }),
      ...
      function ee(Y) {
        if (Y.nodeType == 1) {
          ...
          if (ue) {
            ...
            ve.length && (me = ve[0].find(0)) && j(ir(e.doc, me.from, me.to).join(u));
            return;
          }
        ...
        } else Y.nodeType == 3 && j(Y.nodeValue.replace(/\u200b/g, '').replace(/\u00a0/g, ' '));
      }
    ...
    function xd(e, t, n) {
          ...
          for (var Ce = be < 0 ? f.map : m[be], Ne = 0; Ne < Ce.length; Ne += 3) {
            ...
            if (Fe == me || Fe == ve) {
              var $e = _(be < 0 ? e.line : e.rest[be]),
                Ve = Ce[Ne] + _e;
              return ((_e < 0 || Fe != me) && (Ve = Ce[Ne + (_e ? 1 : 0)]), ne($e, Ve));
            }
          }
      }
      var j = A(l, u, n);
      ...
      for (var ee = u.nextSibling, Y = l ? l.nodeValue.length - n : 0; ee; ee = ee.nextSibling) {
        if (((j = A(ee, ee.firstChild, 0)), j)) return dn(ne(j.line, j.ch - Y), i);
        Y += ee.textContent.length;
      }
      for (var ie = u.previousSibling, ue = n; ie; ie = ie.previousSibling) {
        if (((j = A(ie, ie.firstChild, -1)), j)) return dn(ne(j.line, j.ch + ue), i);
...
`)),
      ...
      (st.prototype.focus = function () {
        if (this.cm.options.readOnly != 'nocursor' && (!E || H(ze(this.textarea)) != this.textarea))
          try {
            this.textarea.focus();
          } catch {}
      }),
      ...
      (st.prototype.poll = function () {
        ...
        if ((s && h >= 9 && this.hasSelection === i) || (O && /[\uf700-\uf7ff]/.test(i)))
  ...
  (function (o) {
    ...
    function S(h) {
      var g = h.getWrapperElement(),
        T = s(h);
      ((g.className =
        g.className.replace(' CodeMirror-empty', '') + (T ? ' CodeMirror-empty' : '')),
        T ? v(h) : p(h));
    }
    function s(h) {
...
var ys = Ke((vs, bs) => {
  (function (o) {
    ...
    o.defineOption('styleSelectedText', !1, function (y, c, d) {
      ...
      c && !k
        ? ((y.state.markedSelection = []),
          (y.state.markedSelectionStyle = typeof c == 'string' ? c : 'CodeMirror-selectedtext'),
          g(y),
    ...
    function s(y, c, d, k) {
      if (S(c, d) != 0)
        for (var z = y.state.markedSelection, M = y.state.markedSelectionStyle, w = c.line; ; ) {
    ...
    function h(y) {
      for (var c = y.state.markedSelection, d = 0; d < c.length; ++d) c[d].clear();
      c.length = 0;
    }
    function g(y) {
      h(y);
      for (var c = y.listSelections(), d = 0; d < c.length; d++) s(y, c[d].from(), c[d].to());
    }
    function T(y) {
      ...
      var z = k[0].find(),
        M = k[k.length - 1].find();
      if (!z || !M || d.line - c.line <= C || S(c, M.to) >= 0 || S(d, z.from) <= 0) return g(y);
      for (; S(c, z.from) > 0; ) (k.shift().clear(), (z = k[0].find()));
      for (
        S(c, z.from) < 0 &&
        (z.to.line - c.line < C ? (k.shift().clear(), s(y, c, z.to, 0)) : s(y, c, z.from, 0));
        S(d, M.to) < 0;
      )
        (k.pop().clear(), (M = k[k.length - 1].find()));
      S(d, M.to) > 0 &&
        (d.line - M.from.line < C ? (k.pop().clear(), s(y, M.from, d)) : s(y, M.to, d));
    }
  });
});
var ks = Ke((xs, _s) => {
  (function (o) {
    ...
    function S(w, W, E) {
      ...
      for (var O = E.line, G = E.ch, J = w.lastLine(); O <= J; O++, G = 0) {
        ...
        var re = w.getLine(O),
          q = W.exec(re);
        if (q) return { from: p(O, q.index), to: p(O, q.index + q[0].length), match: q };
      }
    }
    function s(w, W, E) {
...
`),
          ...
          return {
            from: p(V, x),
            to: p(V + R.length - 1, R.length == 1 ? x + R[0].length : R[R.length - 1].length),
            match: D,
          };
        }
      }
    ...
    function T(w, W, E) {
      ...
      W = C(W, 'gm');
      for (
        var O, G = 1, J = w.getLine(E.line).length - E.ch, re = E.line, q = w.firstLine();
        re >= q;
      ) {
...
`),
          ...
          return {
            from: p(x, K),
            to: p(x + V.length - 1, V.length == 1 ? K + V[0].length : V[V.length - 1].length),
            match: Q,
          };
        }
      }
    ...
    function k(w, W, E, O) {
      ...
      var G = O ? y : c,
        J = G(W).split(/\r|\n\r?/);
      e: for (var re = E.line, q = E.ch, I = w.lastLine() + 1 - J.length; re <= I; re++, q = 0) {
        ...
        if (J.length == 1) {
          ...
          if (R == -1) continue e;
          var E = d(D, Q, R, G) + q;
          return { from: p(re, d(D, Q, R, G) + q), to: p(re, d(D, Q, R + J[0].length, G) + q) };
        } else {
          var V = Q.length - J[0].length;
          if (Q.slice(V) != J[0]) continue e;
          for (var x = 1; x < J.length - 1; x++) if (G(w.getLine(re + x)) != J[x]) continue e;
          var K = w.getLine(re + J.length - 1),
            X = G(K),
            N = J[J.length - 1];
          if (X.slice(0, N.length) != N) continue e;
          return { from: p(re, d(D, Q, V, G) + q), to: p(re + J.length - 1, d(K, X, N.length, G)) };
        }
      }
    }
    function z(w, W, E, O) {
      ...
      var G = O ? y : c,
        J = G(W).split(/\r|\n\r?/);
      e: for (var re = E.line, q = E.ch, I = w.firstLine() - 1 + J.length; re >= I; re--, q = -1) {
        var D = w.getLine(re);
        q > -1 && (D = D.slice(0, q));
        var Q = G(D);
        if (J.length == 1) {
          ...
          if (R == -1) continue e;
          return { from: p(re, d(D, Q, R, G)), to: p(re, d(D, Q, R + J[0].length, G)) };
        } else {
          var V = J[J.length - 1];
...
var Vo = Ke((ws, Ss) => {
  (function (o) {
    ...
    function v(N, H, le, xe) {
      var F = N.indented;
      return (
        N.context && N.context.type == 'statement' && le != 'statement' && (F = N.context.indented),
    ...
    o.defineMode('clike', function (N, H) {
      var le = N.indentUnit,
        ...
        Je = H.numberStart || /[\d\.]/,
        He = H.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
        Ge = H.isOperatorChar || /[+\-*&%=<>!?|\/]/,
      ...
      function te(we, Me) {
        ...
        var B = we.current();
        return h(L, B)
          ? (h(pe, B) && (ce = 'newstatement'), h(Ee, B) && (Be = !0), 'keyword')
          : h(de, B)
            ? 'type'
            : h(ze, B) || (Z && Z(B))
      ...
      return {
        ...
        indent: function (we, Me) {
          ...
          var Le = we.context,
            $ = Me && Me.charAt(0),
            B = $ == Le.type;
          if ((Le.type == 'statement' && $ == '}' && (Le = Le.prev), H.dontIndentStatements))
            for (; Le.type == 'statement' && H.dontIndentStatements.test(Le.info); ) Le = Le.prev;
          if (Oe.indent) {
    ...
    function s(N) {
      for (var H = {}, le = N.split(' '), xe = 0; xe < le.length; ++xe) H[le[xe]] = !0;
      return H;
    }
    function h(N, H) {
    ...
    function G(N) {
      return !N || N.length < 2 || N[0] != '_' ? !1 : N[1] == '_' || N[1] !== N[1].toLowerCase();
    }
    function J(N) {
    ...
    function re(N, H) {
      if ((N.backUp(1), N.match(/^(?:R|u8R|uR|UR|LR)/))) {
        ...
        return le ? ((H.cpp11RawStringDelim = le[1]), (H.tokenize = D), D(N, H)) : !1;
      }
      return N.match(/^(?:u8|u|U|L)/) ? (N.match(/^["']/, !1) ? 'string' : !1) : (N.next(), !1);
    }
    function q(N) {
      var H = /(\w+)::~?(\w+)$/.exec(N);
      return H && H[1] == H[2];
    ...
    function Q(N, H) {
      ...
      (xe(H.keywords),
        ...
        xe(H.builtin),
        xe(H.atoms),
        le.length && ((H.helperType = N[0]), o.registerHelper('hintWords', N[0], le)));
    ...
    (Q(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
        ...
        hooks: {
          ...
          token: function (N, H, le) {
            if (
              le == 'variable' &&
              N.peek() == '(' &&
              (H.prevToken == ';' || H.prevToken == null || H.prevToken == '}') &&
              q(N.current())
            )
              return 'def';
          },
      ...
      Q('text/x-java', {
        ...
        hooks: {
          '@': function (N) {
            return N.match('interface', !1) ? !1 : (N.eatWhile(/[\w\$_]/), 'meta');
          },
          '"': function (N, H) {
      ...
      Q('text/x-csharp', {
        ...
        hooks: {
          '@': function (N, H) {
            return N.eat('"') ? ((H.tokenize = I), I(N, H)) : (N.eatWhile(/[\w\$_]/), 'meta');
          },
        },
      }));
    function R(N, H) {
    ...
    function V(N) {
      return function (H, le) {
        for (var xe; (xe = H.next()); )
          ...
          else if (xe == '/' && H.eat('*')) return ((le.tokenize = V(N + 1)), le.tokenize(H, le));
        return 'comment';
      };
    }
    Q('text/x-scala', {
      ...
      hooks: {
        ...
        '=': function (N, H) {
          ...
          return le.type == '}' && le.align && N.eat('>')
            ? ((H.context = new p(le.indented, le.column, le.type, le.info, null, le.prev)),
              'operator')
            : !1;
        },
        '/': function (N, H) {
    ...
    (Q('text/x-kotlin', {
      ...
      hooks: {
        ...
        indent: function (N, H, le, xe) {
          ...
          if ((N.prevToken == '}' || N.prevToken == ')') && le == '') return N.indented;
          if (
          ...
          if (H.align && H.type == '}')
            return H.indented + (N.context.type == (le || '').charAt(0) ? 0 : xe);
        },
      },
    ...
    Q('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function (N, H) {
          return ((H.tokenize = X(N.match('""') ? 'triple' : 'single')), H.tokenize(N, H));
        },
        '`': function (N, H) {
          return !K || !N.match('`') ? !1 : ((H.tokenize = K), (K = null), H.tokenize(N, H));
        },
        "'": function (N) {
          return (N.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom');
        },
        token: function (N, H, le) {
          if ((le == 'variable' || le == 'type') && H.prevToken == '.') return 'variable-2';
        },
      },
  ...
  (function (o) {
    ...
    o.defineMode('css', function (I, D) {
      ...
      function He(te, fe, oe, Ue) {
        return ((te.context = new Je(oe, fe.indentation() + (Ue === !1 ? 0 : R), te.context)), oe);
      }
      function Ge(te) {
          ...
          return te == '}'
            ...
            : te == 'word'
              ? ((oe.stateArg == '@font-face' && !xe.hasOwnProperty(fe.current().toLowerCase())) ||
                (oe.stateArg == '@counter-style' && !F.hasOwnProperty(fe.current().toLowerCase()))
                  ? (qe = 'error')
                  : (qe = 'property'),
                'maybeprop')
              : 'restricted_atBlock';
    ...
    var v = ['domain', 'regexp', 'url', 'url-prefix'],
      ...
      J = p(G),
      re = v.concat(b).concat(s).concat(g).concat(y).concat(d).concat(E).concat(G);
    ...
    (o.defineMode('xml', function (C, b) {
            ...
            ? x.eat('[')
              ...
              : x.match('--')
                ...
                : x.match('DOCTYPE', !0, !0)
                  ...
                  : null
            : x.eat('?')
              ? (x.eatWhile(/[\w\._\-]/), (K.tokenize = z('meta', '?>')), 'meta')
              : ((T = x.eat('/') ? 'closeTag' : 'openTag'), (K.tokenize = d), 'tag bracket');
        if (N == '&') {
          var H;
          return (
            x.eat('#')
      ...
      function d(x, K) {
        ...
        if (X == '<') {
          ...
          return /[\'\"]/.test(X)
            ? ((K.tokenize = k(X)), (K.stringStartCol = x.column()), K.tokenize(x, K))
            : (x.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), 'word');
      }
      function k(x) {
        var K = function (X, N) {
      ...
      function W(x, K, X) {
        ((this.prev = x.context),
          ...
          (this.startOfLine = X),
          (s.doNotIndent.hasOwnProperty(K) || (x.context && x.context.noIndent)) &&
            (this.noIndent = !0));
      }
      function E(x) {
      ...
      function G(x, K, X) {
        return x == 'openTag' ? ((X.tagStart = K.column()), J) : x == 'closeTag' ? re : G;
      }
      function J(x, K, X) {
        return x == 'word'
      ...
      return {
        ...
        indent: function (x, K, X) {
          ...
          if (x.tokenize.isInAttribute)
            return x.tagStart == x.indented ? x.stringStartCol + 1 : x.indented + S;
          if (N && N.noIndent) return o.Pass;
          if (x.tokenize != d && x.tokenize != c) return X ? X.match(/^(\s*)/)[0].length : 0;
          if (x.tagName)
          ...
          if (H && H[1])
            for (; N; )
              if (N.tagName == H[2]) {
                N = N.prev;
                break;
              } else if (s.implicitlyClosed.hasOwnProperty(w(N.tagName))) N = N.prev;
              else break;
          else if (H)
            for (; N; ) {
    ...
    (o.defineMode('javascript', function (p, v) {
        ...
        if (ae == '/')
          return _.eat('*')
            ...
            : _.eat('/')
              ...
              : jt(_, P, 1)
                ? (k(_), _.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), w('regexp', 'string-2'))
      ...
      function E(_) {
        return function (P, ae) {
          ...
          for (; (ne = P.next()) != null && !(ne == _ && !he); ) he = !he && ne == '\\';
      ...
      function re(_, P) {
        ...
        if (!(ae < 0)) {
          if (g) {
            var he = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(_.string.slice(_.start, ae));
            he && (ae = he.index);
          }
      ...
      function Q(_, P, ae, he, ne) {
        ...
        for (
          ...
          if (Xe(ae, he)) {
            ...
            return R.marked ? R.marked : ae == 'variable' && D(_, he) ? 'variable-2' : P;
          }
        }
      }
      ...
      function X(_) {
        ...
        if (((R.marked = 'def'), !!h)) {
          ...
          v.globalVars && !K(_, P.globalVars) && (P.globalVars = new xe(_, P.globalVars));
        }
      }
      function N(_, P) {
        if (P)
      ...
      function pe(_, P) {
        var ae = function () {
          ...
          if (he.lexical.type == 'stat') ne = he.lexical.indented;
            ...
            for (var ye = he.lexical; ye && ye.type == ')' && ye.align; ye = ye.prev)
              ne = ye.indented;
      ...
      function ge(_) {
        function P(ae) {
          return ae == _ ? x() : _ == ';' || ae == '}' || ae == ')' || ae == ']' ? V() : x(P);
        }
        return P;
      }
      function Oe(_, P) {
                                    ...
                                    ? ((R.marked = 'keyword'),
                                      P == 'enum'
                                        ...
                                        : P == 'type'
                                          ...
                                          : x(pe('form'), Ct, ge('{'), pe('}'), De, Ee, Ee))
                                    : g && P == 'namespace'
                                      ? ((R.marked = 'keyword'), x(pe('form'), Se, Oe, Ee))
                                      : g && P == 'abstract'
                                        ? ((R.marked = 'keyword'), x(Oe))
                                        : x(pe('stat'), Ue)
                                : _ == 'switch'
      ...
      function U(_, P) {
        return _ != 'quasi' ? V() : P.slice(P.length - 2) != '${' ? x(U) : x(Je, Z);
      }
      function Z(_) {
        if (_ == '}') return ((R.marked = 'string-2'), (R.state.tokenize = G), x(U));
      }
      function ce(_) {
      ...
      function B(_, P, ae) {
        function he(ne, ye) {
          ...
          return ne == P || ye == P ? x() : ae && ae.indexOf(';') > -1 ? V(_) : x(ge(P));
        }
      ...
      function Pt(_) {
        if (g && _ == ':') return R.stream.match(/^\s*\w+\s+is\b/, !1) ? x(Se, Ft, Pe) : x(Pe);
      }
      function Ft(_, P) {
      ...
      function Ie(_) {
        return _.match(/[\}\)\]]/) ? x() : _ == ',' || _ == ';' ? x(Ie) : V(nr, Ie);
      }
      function nr(_, P) {
        if (_ == 'variable' || R.style == 'keyword') return ((R.marked = 'property'), x(nr));
      ...
      function _t(_, P) {
        return _ != 'quasi' ? V() : P.slice(P.length - 2) != '${' ? x(_t) : x(Pe, it);
      }
      function it(_) {
        if (_ == '}') return ((R.marked = 'string-2'), (R.state.tokenize = G), x(_t));
      }
      function ot(_, P) {
      ...
      function Ht(_, P) {
        ...
        if (P == 'extends' || P == 'implements') return ((R.marked = 'keyword'), x(Pe));
      ...
      function Br(_, P) {
        if (_ == 'keyword b' && P == 'else') return x(pe('form', 'else'), Oe, Ee);
      }
      function ei(_, P) {
      ...
      function ti(_, P) {
        if (_ == 'keyword' || _ == 'variable') return ((R.marked = 'type'), x(ti));
      ...
      function Kt(_, P) {
        ...
        if (P == 'extends' || P == 'implements' || (g && _ == ','))
          return (P == 'implements' && (R.marked = 'keyword'), x(g ? Pe : Se, Kt));
      ...
      function Gt(_, P) {
        ...
        if (_ == 'variable' || R.style == 'keyword') return ((R.marked = 'property'), x(Cr, Gt));
      ...
      function gr(_) {
        return _ == 'string' ? x() : _ == '(' ? V(Se) : _ == '.' ? V(He) : V(Kr, Vt, Gr);
      }
      function Kr(_, P) {
        return _ == '{'
          ? se(Kr, '}')
      ...
      return {
        ...
        token: function (_, P) {
          ...
          return z == 'comment'
            ? ae
            : ((P.lastType = z == 'operator' && (M == '++' || M == '--') ? 'incdec' : z),
              Q(P, ae, z, M, _));
        },
        indent: function (_, P) {
          ...
          var pt = he.type,
            Et = ae == pt;
          return pt == 'vardef'
            ? he.indented + (_.lastType == 'operator' || _.lastType == ',' ? he.info.length + 1 : 0)
            : pt == 'form' && ae == '{'
              ? he.indented
              : pt == 'form'
                ? he.indented + C
  ...
  (function (o) {
    ...
    function v(T, y, c) {
      ...
      return (
        k > -1
          ? T.backUp(d.length - k)
          : d.match(/<\/?$/) && (T.backUp(d.length), T.match(y, !1) || T.match(d)),
        c
      );
    }
    var C = {};
    function b(T) {
      var y = C[T];
      return y || (C[T] = new RegExp('\\s+' + T + `\\s*=\\s*('|")?([^'"]+)('|")?\\s*`));
    }
    function S(T, y) {
      var c = T.match(b(y));
    ...
    function h(T, y) {
      for (var c in T)
        for (var d = y[c] || (y[c] = []), k = T[c], z = k.length - 1; z >= 0; z--) d.unshift(k[z]);
    }
    function g(T, y) {
          ...
          : c.match(/\b(\w+)\b/)
            ...
            : c.match('%}')
              ? ((d.waitProperty = null),
                ...
                (d.waitDot = null),
                (d.waitPipe = null),
                d.blockCommentTag ? ((d.blockCommentTag = !1), (d.tokenize = y)) : (d.tokenize = S),
                'tag')
              : (c.next(), 'null');
      }
      function T(c, d) {
...
var Di = Ke((Bs, Ws) => {
  (function (o) {
          ...
          copyState: function (re) {
            ...
            for (var I = re.persistentStates; I; I = I.next)
              q.persistentStates = {
                mode: I.mode,
                spec: I.spec,
                state: I.state == re.localState ? q.localState : o.copyState(I.mode, I.state),
    ...
    function p(y, c) {
      if (!y.hasOwnProperty(c)) throw new Error('Undefined state ' + c + ' in simple mode');
    }
    function v(y, c) {
      if (!y) return /(?:)/;
      var d = '';
    ...
    function C(y) {
      ...
      for (var c = [], d = 0; d < y.length; d++) c.push(y[d] && y[d].replace(/\./g, ' '));
      return c;
    }
    function b(y, c) {
          ...
          if (G) {
            (O.data.next
              ...
              : O.data.push
                ...
                : O.data.pop && k.stack && k.stack.length && (k.state = k.stack.pop()),
              O.data.mode && h(c, k, O.data.mode, O.token),
              O.data.indent && k.indent.push(d.indentation() + c.indentUnit),
              O.data.dedent && k.indent.pop());
            var J = O.token;
            if (
              (J && J.apply && (J = J(G)), G.length > 2 && O.token && typeof O.token != 'string')
            ) {
              for (var re = 2; re < G.length; re++)
                G[re] &&
                  (k.pending || (k.pending = [])).push({ text: G[re], token: O.token[re - 1] });
        ...
        e: for (;;) {
          for (var W = 0; W < w.length; W++) {
            ...
            if (E.data.dedent && E.data.dedentIfLineStart !== !1) {
              ...
              if (O && O[0]) {
                (M--, (E.next || E.push) && (w = y[E.next || E.push]), (k = k.slice(O[0].length)));
                continue e;
              }
            }
          }
      ...
      function (p, v) {
        ...
        function re(F, L) {
          ...
          var Se = !ze && !Ee && !L.prevLine.header && (!ge || !pe) && !L.prevLine.fencedCodeEnd,
            je = (L.list === !1 || Ee || ze) && L.indentation <= Oe && F.match(g),
            Ze = null;
          ...
          if (de && L.indentation <= Oe && (Ze = F.match(c)) && Ze[1].length <= 6)
            return (
              (L.quote = 0),
          ...
          if (!je && !L.setext && de && L.indentation <= Oe && (Ze = F.match(T))) {
            var ke = Ze[1] ? 'ol' : 'ul';
            return (
            ...
            if (je) return (F.skipToEnd(), (L.hr = !0), (L.thisLine.hr = !0), s.hr);
        ...
        function I(F, L) {
          var de = L.listStack[L.listStack.length - 1] || 0,
            ze = L.indentation < de,
            pe = de + 3;
          if (L.fencedEndRE && L.indentation <= pe && (ze || F.match(L.fencedEndRE))) {
            v.highlightFormatting && (L.formatting = 'code-block');
            var Ee;
            return (
              ze || (Ee = D(L)),
          ...
          } else return L.localMode ? L.localMode.token(F, L.localState) : (F.skipToEnd(), s.code);
        }
        function D(F) {
          var L = [];
          if (F.formatting) {
            (L.push(s.formatting),
              typeof F.formatting == 'string' && (F.formatting = [F.formatting]));
            for (var de = 0; de < F.formatting.length; de++)
              (L.push(s.formatting + '-' + F.formatting[de]),
                F.formatting[de] === 'header' &&
                  L.push(s.formatting + '-' + F.formatting[de] + '-' + F.header),
                F.formatting[de] === 'quote' &&
                  (!v.maxBlockquoteDepth || v.maxBlockquoteDepth >= F.quote
                    ? L.push(s.formatting + '-' + F.formatting[de] + '-' + F.quote)
                    : L.push('error')));
          }
          if (F.taskOpen) return (L.push('meta'), L.length ? L.join(' ') : null);
          if (F.taskClosed) return (L.push('property'), L.length ? L.join(' ') : null);
          if (
            (F.linkHref
          ...
          return (
            F.trailingSpaceNewLine
              ...
              : F.trailingSpace && L.push('trailing-space-' + (F.trailingSpace % 2 ? 'a' : 'b')),
        ...
        function R(F, L) {
          ...
          if (((L.taskOpen = !1), (L.taskClosed = !1), L.header && F.match(/^#+$/, !0)))
          ...
          if (pe === ']' && L.imageAltText) {
            v.highlightFormatting && (L.formatting = 'image');
            var je = D(L);
            return ((L.imageAltText = !1), (L.image = !1), (L.inline = L.f = x), je);
          }
          if (pe === '[' && !L.image)
            return (
              (L.linkText && F.match(/^.*?\]/)) ||
          ...
          if (v.xml && pe === '<' && F.match(/^\/\w*?>/)) return ((L.md_inside = !1), 'tag');
          if (pe === '*' || pe === '_') {
            for (
            ...
            if (
              (He % 2 &&
                (!L.em && Z && (pe === '*' || !ce || w.test(Ge))
                  ? (Be = !0)
                  : L.em == pe && ce && (pe === '*' || !Z || w.test(U)) && (Be = !1)),
              He > 1 &&
                (!L.strong && Z && (pe === '*' || !ce || w.test(Ge))
                  ? (te = !0)
                  : L.strong == pe && ce && (pe === '*' || !Z || w.test(U)) && (te = !1)),
              te != null || Be != null)
            ) {
        ...
        function V(F, L) {
          var de = F.next();
          if (de === '>') {
            ((L.f = L.inline = R), v.highlightFormatting && (L.formatting = 'link'));
            var ze = D(L);
        ...
        function X(F) {
          return function (L, de) {
            var ze = L.next();
            if (ze === F) {
              ((de.f = de.inline = R), v.highlightFormatting && (de.formatting = 'link-string'));
              var pe = D(de);
        ...
        var xe = {
          ...
          copyState: function (F) {
            return {
              ...
              localState: F.localMode ? o.copyState(F.localMode, F.localState) : null,
              inline: F.inline,
              text: F.text,
              formatting: !1,
              linkText: F.linkText,
          ...
          token: function (F, L) {
            if (((L.formatting = !1), F != L.thisLine.stream)) {
              if (((L.header = 0), (L.hr = !1), F.match(/^\s*$/, !0))) return (J(L), null);
              if (
        ...
        var s = {
            ...
            token: function (T, y) {
              if (((y.combineTokens = null), y.codeBlock))
                return T.match(/^```+/) ? ((y.codeBlock = !1), null) : (T.skipToEnd(), null);
              ...
              if (T.peek() === '`') {
                ...
                T.eatWhile('`');
                var d = 1 + T.pos - c;
                return (y.code ? d === b && (y.code = !1) : ((b = d), (y.code = !0)), null);
              } else if (y.code) return (T.next(), null);
              if (T.eatSpace()) return ((y.ateSpace = !0), null);
              if ((T.sol() || y.ateSpace) && ((y.ateSpace = !1), C.gitHubSpice !== !1)) {
                if (
                  T.match(
    ...
    (o.defineMode('go', function (p) {
      ...
      function d(k) {
        if (k.context.prev) {
          ...
          return (
            (z == ')' || z == ']' || z == '}') && (k.indented = k.context.indented),
      ...
      function (C, b) {
        ...
        function T(c, d, k) {
          ...
          if (k.depth == 1) {
            if (c.peek() == '<')
              return (
                S.skipAttribute(k.state),
                (d.context = new p(o.startState(S, h(k.state)), S, 0, d.context)),
                null
              );
        ...
        function y(c, d, k) {
          if (
            ...
            return (
              (d.context = new p(o.startState(S, s.indent(k.state, '', '')), S, 0, d.context)),
...
var gu = Ke((pu, hu) => {
  (function (o) {
    ...
    (o.defineMode('nginx', function (p) {
      function v(k) {
        for (var z = {}, M = k.split(' '), w = 0; w < M.length; ++w) z[M[w]] = !0;
        return z;
      }
      var C = v(
      ...
      function d(k) {
        return function (z, M) {
          for (var w = !1, W; (W = z.next()) != null && !(W == k && !w); ) w = !w && W == '\\';
      ...
      return {
        ...
        token: function (k, z) {
          ...
          return (
            h == 'hash' && w == 'rule'
              ? (M = 'atom')
              : M == 'variable' &&
                (w == 'rule' ? (M = 'number') : (!w || w == '@media{') && (M = 'tag')),
        ...
        indent: function (k, z) {
          ...
          return (
            /^\}/.test(z) && (M -= k.stack[k.stack.length - 1] == 'rule' ? 2 : 1),
            k.baseIndent + M * s
          );
        },
        electricChars: '}',
  ...
  (function (o) {
      ...
      return T.length == 0
        ...
        : function (d, k) {
            for (var z = T[0], M = 0; M < z.length; M++)
              if (d.match(z[M][0])) return ((k.tokenize = v(T.slice(1), y)), z[M][1]);
    ...
    function b(T, y, c, d) {
      ...
      if (d !== !1 && T.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/))
        return (
          ...
          T.match(/^->\w/, !1) && (y.tokenize = v([[['->', null]], [[/[\w]+/, 'variable']]], c, d)),
          'variable-2'
        );
      for (
        var k = !1;
        !T.eol() &&
        (k || d === !1 || (!T.match('{$', !1) && !T.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1)));
      ) {
        if (!k && T.match(c)) {
    ...
    var g = {
      ...
      hooks: {
        ...
        '"': function (T, y) {
          return ((y.tokStack || (y.tokStack = [])).push('"', 0), (y.tokenize = C('"')), 'string');
        },
        '{': function (T, y) {
          return (y.tokStack && y.tokStack.length && y.tokStack[y.tokStack.length - 1]++, !1);
        },
        '}': function (T, y) {
          return (
            y.tokStack &&
    ...
    (o.defineMode(
      ...
      function (T, y) {
        ...
        function k(z, M) {
          var w = M.curMode == d;
          if (
            (z.sol() && M.pending && M.pending != '"' && M.pending != "'" && (M.pending = null), w)
          )
        ...
        return {
          ...
          copyState: function (z) {
            ...
            return (
              z.curMode == c ? (O = w) : (O = E),
              { html: w, php: E, curMode: z.curMode, curState: O, pending: z.pending }
            );
          },
          token: k,
...
var Mu = Ke((Eu, zu) => {
  (function (o) {
    ...
    (o.defineMode('python', function (h, g) {
      ...
      function J(K, X) {
        ...
        if ((N && (X.indent = K.indentation()), N && S(X).type == 'py')) {
          ...
          if (K.eatSpace()) {
            ...
            return (
              le > H ? D(X) : le < H && R(K, X) && K.peek() != '#' && (X.errorToken = !0),
              null
            );
          } else {
            var xe = re(K, X);
          ...
          return function (L, de) {
            ...
            return (
              ze == 'punctuation' &&
                (L.current() == '{'
                  ? (de.tokenize = le(F + 1))
                  : L.current() == '}' && (F > 1 ? (de.tokenize = le(F - 1)) : (de.tokenize = xe))),
              ze
            );
          };
        }
        function xe(F, L) {
          for (; !F.eol(); )
            if ((F.eatWhile(/[^'"\{\}\\]/), F.eat('\\'))) {
              ...
              if (F.match('{{')) return H;
              if (F.match('{', !1))
                return ((L.tokenize = le(0)), F.current() ? H : L.tokenize(F, L));
              if (F.match('}}')) return H;
              if (F.match('}')) return T;
              F.eat(/['"]/);
            }
      ...
      function R(K, X) {
        for (var N = K.indentation(); X.scopes.length > 1 && S(X).offset > N; ) {
      ...
      function V(K, X) {
        ...
        var N = X.tokenize(K, X),
          H = K.current();
        if (X.beginningOfLine && H == '@') return K.match(W, !1) ? 'meta' : w ? 'operator' : T;
        if (
          (/\S/.test(H) && (X.beginningOfLine = !1),
          (N == 'variable' || N == 'builtin') && X.lastToken == 'meta' && (N = 'meta'),
          (H == 'pass' || H == 'return') && (X.dedent = !0),
          H == 'lambda' && (X.lambda = !0),
          H == ':' && !X.lambda && S(X).type == 'py' && K.match(/^\s*(?:#|$)/, !1) && D(X),
          H.length == 1 && !/string|comment/.test(N))
        ) {
          var le = '[({'.indexOf(H);
          if ((le != -1 && Q(K, X, '])}'.slice(le, le + 1)), (le = '])}'.indexOf(H)), le != -1))
            if (S(X).type == H) X.indent = X.scopes.pop().offset - k;
            else return T;
        }
        return (
          X.dedent && K.eol() && S(X).type == 'py' && X.scopes.length > 1 && X.scopes.pop(),
          N
        );
      }
      var x = {
        ...
        token: function (K, X) {
          ...
          return (
            H &&
              H != 'comment' &&
              (X.lastToken = H == 'keyword' || H == 'punctuation' ? K.current() : H),
        ...
        indent: function (K, X) {
          ...
          var N = S(K),
            H =
              N.type == X.charAt(0) ||
              (N.type == 'py' && !K.dedent && /^(else:|elif |except |finally:)/.test(X));
          return N.align != null ? N.align - (H ? 1 : 0) : N.offset - (H ? k : 0);
        },
...
var qu = Ke((Au, Du) => {
  (function (o) {
    ...
    (o.defineMode('ruby', function (g) {
      ...
      function c(E, O) {
        if (E.sol() && E.match('=begin') && E.eol()) return (O.tokenize.push(W), 'comment');
        if (E.eatSpace()) return null;
        var G = E.next(),
          J;
        if (G == '`' || G == "'" || G == '"') return y(M(G, 'string', G == '"' || G == '`'), E, O);
        ...
        if (G == '%') {
          ...
          var I = E.eat(/[^\w\s=]/);
          return I
            ? (s.propertyIsEnumerable(I) && (I = s[I]), y(M(I, re, q, !0), E, O))
            : 'operator';
        } else {
          if (G == '#') return (E.skipToEnd(), 'comment');
          if (G == '<' && (J = E.match(/^<([-~])[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/)))
          ...
          if (G == '?') {
            ...
            if (G == '|' && (O.varList || O.lastTok == '{' || O.lastTok == 'do'))
              return ((T = '|'), null);
      ...
      function k(E) {
        return (
          ...
          function (O, G) {
            if (O.peek() == '}') {
              if (E == 1) return (G.tokenize.pop(), G.tokenize[G.tokenize.length - 1](O, G));
              G.tokenize[G.tokenize.length - 1] = k(E - 1);
            } else O.peek() == '{' && (G.tokenize[G.tokenize.length - 1] = k(E + 1));
            return c(O, G);
          }
        );
      }
      ...
      function w(E, O) {
        return function (G, J) {
          return (O && G.eatSpace(), G.match(E) ? J.tokenize.pop() : G.skipToEnd(), 'string');
        };
      }
      function W(E, O) {
        return (
      ...
      return {
        ...
        token: function (E, O) {
          ...
          return (
            ...
            J == 'indent' || /[\(\[\{]/.test(T)
              ? (O.context = { prev: O.context, type: T || G, indented: O.indented })
              : (J == 'dedent' || /[\)\]\}]/.test(T)) &&
                O.context.prev &&
        ...
        indent: function (E, O) {
          ...
          var G = O && O.charAt(0),
            ...
            re =
              J.type == h[G] ||
              (J.type == 'keyword' && /^(?:end|until|else|elsif|when|rescue)\b/.test(O));
  ...
  (function (o) {
    ...
    (o.defineMode(
      ...
      function (p) {
        ...
        function w(q, I) {
          return function (D, Q) {
            return D.sol() && D.indentation() <= q
              ? ((Q.tokenizer = J), J(D, Q))
              : (I && D.skipTo('*/') ? (D.next(), D.next(), (Q.tokenizer = J)) : D.skipToEnd(),
                'comment');
          };
        }
        function W(q, I) {
          ...
          function D(Q, R) {
            var V = Q.next(),
              ...
              X = (V !== '\\' && x === q) || (V === q && K !== '\\');
            return X
              ? (V !== q && I && Q.next(), z(Q) && (R.cursorHalf = 0), (R.tokenizer = J), 'string')
              : V === '#' && x === '{'
        ...
        function E(q) {
          return function (I, D) {
            return I.peek() === '}' ? (I.next(), (D.tokenizer = q), 'operator') : J(I, D);
          };
        }
        function O(q) {
          if (q.indentCount == 0) {
        ...
        function J(q, I) {
          var D = q.peek();
          if (q.match('/*')) return ((I.tokenizer = w(q.indentation(), !0)), I.tokenizer(q, I));
          if (q.match('//')) return ((I.tokenizer = w(q.indentation(), !1)), I.tokenizer(q, I));
          if (q.match('#{')) return ((I.tokenizer = E(J)), 'operator');
          if (D === '"' || D === "'") return (q.next(), (I.tokenizer = W(D)), 'string');
          if (I.cursorHalf) {
            if (
            ...
            if (q.match(/^(px|em|in)\b/)) return (z(q) && (I.cursorHalf = 0), 'unit');
            if (q.match(T)) return (z(q) && (I.cursorHalf = 0), 'keyword');
            if (q.match(/^url/) && q.peek() === '(')
              return ((I.tokenizer = M), z(q) && (I.cursorHalf = 0), 'atom');
            if (D === '$')
              return (q.next(), q.eatWhile(/[\w-]/), z(q) && (I.cursorHalf = 0), 'variable-2');
            if (D === '!')
              return (q.next(), (I.cursorHalf = 0), q.match(/^[\w]+/) ? 'keyword' : 'operator');
            ...
            if (q.match(/^url/) && q.peek() === '(') return ((I.tokenizer = M), 'atom');
            ...
            if (q.eatWhile(/[\w-]/))
              if (q.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                ...
                return q.match(/ *:/, !1)
                  ? (O(I), (I.cursorHalf = 1), (I.prevProp = q.current().toLowerCase()), 'property')
                  : (q.match(/ *,/, !1) || O(I), 'tag');
            if (D === ':')
              return q.match(d) ? 'variable-3' : (q.next(), (I.cursorHalf = 1), 'operator');
          }
        ...
        function re(q, I) {
          ...
          if (((Q === '@return' || Q === '}') && G(I), D !== null)) {
            for (
              var R = q.pos - Q.length, V = R + p.indentUnit * I.indentCount, x = [], K = 0;
              K < I.scopes.length;
              K++
            ) {
              var X = I.scopes[K];
  ...
  (function (o) {
    ...
    (o.defineMode('shell', function () {
      ...
      function s(d, k) {
        ...
        if (M === "'" || M === '"' || M === '`')
          return (k.tokens.unshift(h(M, M === '`' ? 'quote' : 'string')), c(d, k));
        if (M === '#')
          return z && d.eat('!') ? (d.skipToEnd(), 'meta') : (d.skipToEnd(), 'comment');
        ...
        return function (M, w) {
          for (var W, E = !1; (W = M.next()) != null; ) {
            if (W === z && !E) {
              ...
              if (!E && d !== z && W === d) return (w.tokens.unshift(h(d, k)), c(M, w));
              if (!E && /['"]/.test(W) && !/['"]/.test(d)) {
  ...
  (function (o) {
    ...
    o.defineMode('sql', function (g, T) {
      ...
      function J(Q, R) {
        ...
        if (V == '/' && Q.eat('*')) return ((R.tokenize = q(1)), R.tokenize(Q, R));
        if (V == '.') {
      ...
      function I(Q, R, V) {
        R.context = { prev: R.context, indent: Q.indentation(), col: Q.column(), type: V };
      }
      function D(Q) {
      ...
      return {
        ...
        token: function (Q, R) {
          if (
            (Q.sol() && R.context && R.context.align == null && (R.context.align = !1),
        ...
        indent: function (Q, R) {
          ...
          return V.align ? V.col + (x ? 0 : 1) : V.indent + (x ? 0 : g.indentUnit);
        },
        blockCommentStart: '/*',
        blockCommentEnd: '*/',
  ...
  (function (o) {
    ...
    o.defineMode('stylus', function (E) {
      ...
      function Oe($, B) {
        ...
        if (ze == '"' || ze == "'") return ($.next(), (B.tokenize = Se(ze)), B.tokenize($, B));
      ...
      function je($, B) {
        return (
          $.next(),
          $.match(/\s*[\"\')]/, !1) ? (B.tokenize = null) : (B.tokenize = Se(')')),
          [null, '(']
        );
      }
      function Ze($, B, se, De) {
      ...
      function fe($, B) {
        return (
          (Me(B) && ($ == '{' || $ == ']' || $ == 'hash' || $ == 'qualifier')) || $ == 'block-mixin'
        );
      }
      function oe($, B) {
      ...
      return (
        (de.block = function ($, B, se) {
          ...
          if (Me(B) && $ == ']' && !/^\s*(\.|#|:|\[|\*|&)/.test(B.string) && !U(Le(B)))
            return ke(se, B, 'block', 0);
          ...
          if ($ == '=') return !Me(B) && !ce(Le(B)) ? ke(se, B, 'block', 0) : ke(se, B, 'block');
          if ($ == '*' && (Me(B) || B.match(/\s*(,|\.|#|\[|:|{)/, !1)))
          ...
          if (/@(-(moz|ms|o|webkit)-)?keyframes$/.test($)) return ke(se, B, 'keyframes');
          ...
          if ($ == 'word') {
            ...
            if (ge == 'tag') {
              if (
                ...
                B.string.match(new RegExp('\\[\\s*' + De + '|' + De + '\\s*\\]'))
              )
                return ((ge = 'atom'), 'block');
              if (
                re.test(De) &&
                ((we(B) && B.string.match(/=/)) ||
                  (!we(B) && !B.string.match(/^(\s*\.|#|\&|\[|\/|>|\*)/) && !U(Le(B))))
              )
                return ((ge = 'variable-2'), ce(Le(B)) ? 'block' : ke(se, B, 'block', 0));
              if (Me(B)) return ke(se, B, 'block');
            }
            if (ge == 'block-keyword')
              return (
                (ge = 'keyword'),
                B.current(/(if|unless)/) && !we(B) ? 'block' : ke(se, B, 'block')
              );
              ...
              : (B.string.match(/^[a-z][\w-]*\(/i) && Me(B)) ||
                ...
                : B.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) ||
                  ...
                  : Me(B)
                    ...
                    : ke(se, B, 'block', 0);
          if (
            ($ && $.charAt(0) == '@' && Z(B.current().slice(1)) && (ge = 'variable-2'), $ == 'word')
          ) {
            var De = B.current();
            ((ge = te(De)),
        ...
        (de.vendorPrefixes = function ($, B, se) {
          return $ == 'word' ? ((ge = 'property'), ke(se, B, 'block', 0)) : Je(se);
        }),
        (de.pseudo = function ($, B, se) {
          return Z(Le(B.string))
            ? Ge($, B, se)
            : (B.match(/^[a-z-]+/), (ge = 'variable-3'), Me(B) ? ke(se, B, 'block') : Je(se));
        }),
        (de.atBlock = function ($, B, se) {
          ...
          return (
            $ == 'operator' && /^(not|and|or)$/.test(B.current()) && (ge = 'keyword'),
            se.context.type
          );
        }),
        ...
        (de.keyframes = function ($, B, se) {
          return B.indentation() == '0' &&
            (($ == '}' && we(B)) || $ == ']' || $ == 'hash' || $ == 'qualifier' || U(B.current()))
            ? Ge($, B, se)
            : $ == '{'
              ? ke(se, B, 'keyframes')
              : $ == '}'
                ...
                : $ == 'unit' && /^[0-9]+\%$/.test(B.current())
                  ? ke(se, B, 'keyframes')
                  : $ == 'word' && ((ge = te(B.current())), ge == 'block-keyword')
        ...
        (de.interpolation = function ($, B, se) {
          return (
            ...
            $ == '}'
              ...
              : $ == 'variable-name'
                ? ke(se, B, 'variableName', 0)
                : ($ == 'word' && ((ge = te(B.current())), ge == 'tag' && (ge = 'atom')),
                  se.context.type)
          );
        }),
        ...
        (de.variableName = function ($, B, se) {
          return $ == 'string' || $ == '[' || $ == ']' || B.current().match(/^(\.|\$)/)
            ? (B.current().match(/^\.[\w-]+/i) && (ge = 'variable-2'), 'variableName')
            : Ge($, B, se);
        }),
        {
          startState: function ($) {
    ...
    var p = [
      ...
      y = ['in', 'and', 'or', 'not', 'is not', 'is a', 'is', 'isnt', 'defined', 'if unless'],
...
var Xu = Ke((Gu, Zu) => {
  (function (o) {
    ...
    var v = p([
      ...
      g = /^\-?0b[01][01_]*/,
      T = /^\-?0o[0-7][0-7_]*/,
      y = /^\-?0x[\dA-Fa-f][\dA-Fa-f_]*(?:(?:\.[\dA-Fa-f][\dA-Fa-f_]*)?[Pp]\-?\d[\d_]*)?/,
      c = /^\-?\d[\d_]*(?:\.\d[\d_]*)?(?:[Ee]\-?\d[\d_]*)?/,
      ...
      return function (I, D, Q) {
        ...
        if (R == 'punctuation') {
          if (I.current() == '(') ++q;
            ...
            if (q == 0)
              return (I.backUp(1), D.tokenize.pop(), D.tokenize[D.tokenize.length - 1](I, D));
            --q;
          }
        }
        return R;
    ...
    (o.defineMode('swift', function (q) {
      return {
        ...
        indent: function (I, D) {
          ...
          if (!Q) return 0;
          var R = /^[\]\}\)]/.test(D);
          return Q.align != null ? Q.align - (R ? 1 : 0) : Q.indented + (R ? 0 : q.indentUnit);
        },
        electricInput: /^\s*[\)\}\]]$/,
        lineComment: '//',
        blockCommentStart: '/*',
    ...
    (o.defineMode('coffeescript', function (p, v) {
      ...
      function W(I, D) {
        if (I.sol()) {
          ...
          if (I.eatSpace()) {
            var R = I.indentation();
            return R > Q && D.scope.type == 'coffee' ? 'indent' : R < Q ? 'dedent' : null;
          } else Q > 0 && J(I, D);
        }
        ...
        if (I.match(k)) return ((D.tokenize = E(I.current(), !1, 'string')), D.tokenize(I, D));
        if (I.match(z)) {
          if (I.current() != '/' || I.match(/^.*\//, !1))
            return ((D.tokenize = E(I.current(), !0, 'string-2')), D.tokenize(I, D));
          I.backUp(1);
        }
      ...
      function G(I, D, Q) {
        ...
        (Q !== 'coffee'
          ...
          (D.scope = { offset: R, type: Q, prev: D.scope, align: V, alignOffset: x }));
      }
      function J(I, D) {
        if (D.scope.prev)
      ...
      var q = {
        ...
        token: function (I, D) {
          ...
          return (
            R &&
              R != 'comment' &&
              (Q && (Q.align = !0), (D.prop = R == 'punctuation' && I.current() == '.')),
            R
          );
        },
        indent: function (I, D) {
    ...
    (o.defineMode(
      ...
      function (p) {
        ...
        function Oe(U, Z) {
          if (U.match(/^(?:\| ?| )([^\n]+)/)) return 'string';
          if (U.match(/^(<[^\n]*)/, !1))
            return (je(U, Z, 'htmlmixed'), (Z.innerModeForLine = !0), Ze(U, Z, !0));
        }
        function qe(U, Z) {
          if (U.eat('.')) {
            var ce = null;
      ...
      return {
        ...
        token: function (b, S) {
          if (S.innerActive) {
            ...
            var y = z.close && !S.startingInner ? C(h, z.close, b.pos, z.parseDelimiters) : -1;
            ...
            return (
              y > -1 ? (b.string = h) : b.pos > b.start && (S.startingInner = !1),
              y == b.pos && z.parseDelimiters && (S.innerActive = S.inner = null),
      ...
      return {
        token: function (C, b) {
          ...
          if ((b.literal && (b.literal = !1), C.sol())) {
            if (
              ((b.keyCol = 0), (b.pair = !1), (b.pairStart = !1), C.match('---') || C.match('...'))
            )
              return 'def';
...
function Pi(o) {
  ...
  function b(K, X, N, H, le) {
    ((N = N || K.getLineHandle(X)),
      ...
      (le = le || (!!N.text && K.getTokenAt({ line: X, ch: N.text.length - 1 }))));
...
`),
  ...
  if (c === 'single') {
    ...
    (s.replaceRange(M + w, { line: h.line, ch: 0 }, { line: h.line, ch: 99999999999999 }),
      h.ch--,
      h !== g && g.ch--,
      s.setSelection(h, g),
      s.focus());
...
`),
        ...
        s.operation(function () {
          (s.replaceRange(J, { line: re, ch: 0 }, { line: re + (J ? 0 : 1), ch: 0 }),
            s.replaceRange(O, { line: G, ch: 0 }, { line: G + (O ? 0 : 1), ch: 0 }));
        }),
        s.setSelection({ line: G + (O ? 1 : 0), ch: 0 }, { line: re + (O ? 1 : -1), ch: 0 }),
        s.focus());
    } else {
      var q = h.line;
      if (
      ...
      if (k === void 0)
        for (z = s.lineCount(), k = q; k < z && ((y = s.getLineHandle(k)), !v(y)); k++);
      (s.operation(function () {
    ...
    if (h.line !== g.line || h.ch !== g.ch) ((d = h.line), (k = g.line), g.ch === 0 && k--);
      ...
      for (d = h.line; d >= 0; d--)
        if (((y = s.getLineHandle(d)), !y.text.match(/^\s*$/) && b(s, d, y) !== 'indented')) {
          d += 1;
          break;
        }
      for (z = s.lineCount(), k = h.line; k < z; k++)
        if (((y = s.getLineHandle(k)), !y.text.match(/^\s*$/) && b(s, k, y) !== 'indented')) {
          k -= 1;
          break;
        }
    }
...
function bn(o) {
  ...
  if ((p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = y), S)) {
  ...
  if (!o.getWrapperElement().lastChild.classList.contains('editor-preview-active')) {
    for (
      ...
      (function (z) {
        ...
        (S[p]
          ? (M = M.replace(g[p], '$1'))
          : (p == 'unordered-list' && (M = c('ordered-list', M, !0)), (M = c(p, M, !1)), (d += 1)),
...
function xc(o, p, v, C) {
  if (!(!o.codemirror || o.isPreviewActive())) {
    ...
    (p == 'link'
      ...
      (c = c.replace(/]\(.*?\)/, '')),
      b.replaceRange(y + c, { line: h.line, ch: 0 }, { line: h.line, ch: 99999999999999 }),
      (h.ch -= v[0].length),
      h !== g && (g.ch -= v[0].length),
      b.setSelection(h, g),
      b.focus());
        ...
        p.shortcuts[s] !== null &&
          ...
          (function (E) {
            C[vc(p.shortcuts[E])] = function () {
              var O = Vn[E];
              typeof O == 'function' ? O(v) : typeof O == 'string' && window.open(O, '_blank');
            };
          })(s);
      ...
      function w() {
        p.previewImagesInEditor &&
          c.querySelectorAll('.cm-image-marker').forEach(function (E) {
            ...
            if (O.innerText.match(/^!\[.*?\]\(.*\)/g) && !O.hasAttribute('data-img-src')) {
              ...
              if (
                (T === '|'
                  ...
                  : T.children
                    ...
                    : (y = qi(T, !0, C.options.toolbarTips, C.options.shortcuts, 'button', C)),
                (b[T.name || T] = y),
                v.appendChild(y),
                T.name === 'upload-image')
              ) {
  ...
  return {
    ...
    getToolbar: function () {
      ...
      return (
        ...
        ['heading'].some((k) => y.includes(k)) &&
          ['blockquote', 'codeBlock', 'bulletList', 'orderedList'].some((k) => y.includes(k)) &&
          d.push('|'),
        ...
        ['table', 'attachFiles'].some((k) => y.includes(k)) &&
          ...
          d.push('|'),
        y.includes('undo') &&
          d.push({ name: 'undo', action: EasyMDE.undo, title: T.toolbar_buttons?.undo }),
        y.includes('redo') &&
          d.push({ name: 'redo', action: EasyMDE.redo, title: T.toolbar_buttons?.redo }),
        d
      );
    },
  };

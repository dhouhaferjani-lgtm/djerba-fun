var po = '2.1.15',
  ...
  xe = {
    ...
    supportsInputEvents:
      typeof InputEvent < 'u' &&
      ['data', 'getTargetRanges', 'inputType'].every((i) => i in InputEvent.prototype),
  },
  ...
  $i = function (i) {
    let { strict: t } =
      arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : { strict: !0 };
    return t
      ? Vt(i)
      : Vt(i) ||
          (!Vt(i.firstChild) &&
...
`,
  ...
  xo =
    ((Tn = Array.from) === null || Tn === void 0 ? void 0 : Tn.call(Array, '\u{1F47C}').length) ===
    1,
...
var So = 0,
  ...
  y = function (i) {
    if (i != null)
      return (Array.isArray(i) || (i = [i, i]), [tr(i[0]), tr(i[1] != null ? i[1] : i[0])]);
  },
  ut = function (i) {
    if (i == null) return;
    let [t, e] = y(i);
  ...
  Ue = class extends R {
    ...
    start() {
      this.started ||
        ((this.started = !0), document.addEventListener('selectionchange', this.update, !0));
    }
    stop() {
      if (this.started)
        return (
  ...
  he = (i) =>
    i.replace(new RegExp(''.concat(ln), 'g'), '').replace(new RegExp(''.concat(ft), 'g'), ' '),
    ...
    findOrCreateCachedChildView(t, e, n) {
      ...
      return (
        r
          ...
          : ((r = this.createChildView(...arguments)), this.cacheViewForObject(r, e)),
        r
      );
    }
    createChildView(t, e) {
...
var lr = z([
  ...
  Ve = (function i() {
    let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : rs(),
      e = (a) => i(a);
    if (
      ((e.version = '3.2.5'),
      (e.removed = []),
    ...
    e.isSupported =
      typeof Ur == 'function' && typeof F == 'function' && xt && xt.createHTMLDocument !== void 0;
    let {
        MUSTACHE_EXPR: un,
        ERB_EXPR: hn,
        TMPLIT_EXPR: dn,
      ...
      Cn = function () {
        ...
        if (!Wt || Wt !== a) {
          if (
            ((a && typeof a == 'object') || (a = {}),
            (a = St(a)),
            (ie = ho.indexOf(a.PARSER_MEDIA_TYPE) === -1 ? 'text/html' : a.PARSER_MEDIA_TYPE),
            (I = ie === 'application/xhtml+xml' ? Fn : _e),
            (N = Y(a, 'ALLOWED_TAGS') ? b({}, a.ALLOWED_TAGS, I) : ki),
            (O = Y(a, 'ALLOWED_ATTR') ? b({}, a.ALLOWED_ATTR, I) : Ri),
            (xn = Y(a, 'ALLOWED_NAMESPACES') ? b({}, a.ALLOWED_NAMESPACES, Fn) : co),
            (An = Y(a, 'ADD_URI_SAFE_ATTR') ? b(St(Pi), a.ADD_URI_SAFE_ATTR, I) : Pi),
            (Oi = Y(a, 'ADD_DATA_URI_TAGS') ? b(St(Fi), a.ADD_DATA_URI_TAGS, I) : Fi),
        ...
        return a instanceof u &&
          ...
          : (h !== 'noscript' && h !== 'noembed' && h !== 'noframes') ||
            ...
            ? (Pt &&
                ...
                a.textContent !== g &&
                  (se(e.removed, { element: a.cloneNode() }), (a.textContent = g))),
          ...
          if (!(Ti && j(so, g))) {
            if (!O[g] || gn[g]) {
              if (
                !(
                  (Hi(a) &&
                    ((w.tagNameCheck instanceof RegExp && j(w.tagNameCheck, a)) ||
                      (w.tagNameCheck instanceof Function && w.tagNameCheck(a))) &&
                    ((w.attributeNameCheck instanceof RegExp && j(w.attributeNameCheck, g)) ||
      ...
      qi = function (a) {
        ...
        for (; v--; ) {
          ...
          if (
            ...
            (_ = h.attrValue),
            !Ni || (et !== 'id' && et !== 'name') || (Le(f, a), (_ = 'user-content-' + _)),
      ...
      (e.sanitize = function (a) {
        ...
        if ((fn || Cn(g), (e.removed = []), typeof a == 'string' && (ne = !1), ne)) {
          ...
          ((h = ji('<!---->')),
            ...
            (v.nodeType === Qo && v.nodeName === 'BODY') || v.nodeName === 'HTML'
              ? (h = v)
              : h.appendChild(v));
        else {
...
var os = 'style href src width height language class'.split(' '),
  ...
  ve = class extends dt {
    ...
    createNodes() {
      ...
      return (
        n &&
          ((t = p({ tagName: 'a', editable: !1, attributes: { href: n, tabindex: -1 } })),
          e.appendChild(t)),
  ...
  gr = (i) =>
    p({ tagName: 'span', textContent: ln, data: { trixCursorTarget: i, trixSerialize: !1 } }),
  cs = function (i, t) {
    let e = p('div');
  ...
  ze = class extends ve {
    ...
    refresh(t) {
      ...
      if (
        (t ||
          (t = (e = this.findElement()) === null || e === void 0 ? void 0 : e.querySelector('img')),
        t)
      )
...
((Oe.prototype[(typeof Symbol == 'function' && Symbol.asyncIterator) || '@@asyncIterator'] =
  function () {
    return this;
  }),
...
var Gt = class i extends gt {
  ...
  isEqualTo(t) {
    ...
    return (
      super.isEqualTo(t) &&
      this.attachment.id ===
        (t == null || (e = t.attachment) === null || e === void 0 ? void 0 : e.id)
    );
  }
  toString() {
    return '\uFFFC';
...
var Yt = class extends ht {
  ...
  K = class extends ht {
    ...
    removeAttributeAtRange(t, e) {
      return this.copyWithPieceList(
        this.pieceList.transformObjectsInRange(e, (n) => n.copyWithoutAttribute(t))
      );
    }
    setAttributesAtRange(t, e) {
      return this.copyWithPieceList(
        this.pieceList.transformObjectsInRange(e, (n) => n.copyWithAttributes(t))
      );
    }
...
`);
    ...
    canBeConsolidatedWith(t) {
      return (
        !this.hasAttributes() && !t.hasAttributes() && this.getDirection() === t.getDirection()
      );
    }
    consolidateWith(t) {
...
`),
  ...
  ys = function (i) {
    let t = !1,
      ...
      r = e[e.length - 1];
    return r
      ? ((n = n.map((o) => (o.isBlockBreak() ? ((t = !0), Es(o)) : o))), t ? new K([...n, r]) : i)
      : i;
  },
...
`
    ...
    insertBlockBreakAtRange(t) {
      ...
      return (
        r === 0 && (e = [new bt()]),
        new this.constructor(o.blockList.insertSplittableListAtPosition(new Yt(e), n))
      );
    }
    ...
    parse() {
      try {
        (this.createHiddenContainer(),
          qt.setHTML(this.containerElement, this.html, { purifyOptions: this.purifyOptions }));
...
`);
    ...
    processTextNode(t) {
      ...
      return (
        Cr(t.parentNode) ||
          ((e = xi(e)),
          Gr((n = t.previousSibling) === null || n === void 0 ? void 0 : n.textContent) &&
            (e = Rs(e))),
...
`,
    ...
    getTextAttributes(t) {
      ...
      for (let r in Dt) {
        let o = Dt[r];
        if (o.tagName && vt(t, { matchingSelector: o.tagName, untilNode: this.containerElement }))
          n[r] = !0;
        else if (o.parser) {
          if (((e = o.parser(t)), e)) {
            let s = !1;
    ...
    isInsignificantTextNode(t) {
      ...
      return (Ss(e.previousSibling) && !this.isBlockElement(e.previousSibling)) || Cr(e)
        ? void 0
...
`,
    ...
    getMarginOfBlockElementAtIndex(t) {
      ...
      if (e && e.textContent && !ge().includes(W(e)) && !this.processedElements.includes(e))
        return Er(e);
    }
...
`);
    ...
    insertHTML(t) {
      let e = Ft.parse(t, { purifyOptions: { SAFE_FOR_XML: !0 } }).getDocument(),
        n = this.getSelectedRange();
    ...
    shouldManageDeletingInDirection(t) {
      ...
      if (ut(e)) {
        if ((t === 'backward' && e[0].offset === 0) || this.shouldManageMovingCursorInDirection(t))
          return !0;
...
var ye = class extends R {
  ...
  Os = (i, t, e) => i?.description === t?.toString() && i?.context === JSON.stringify(e),
...
` &&
  ...
  Ze = class {
    ...
    findLocationFromContainerAndOffset(t, e) {
      let { strict: n } =
          arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : { strict: !0 },
        r = 0,
        o = !1,
        s = { index: 0, offset: 0 },
  ...
  ct = class extends R {
    ...
    createLocationRangeFromDOMRange(t, e) {
      ...
      let r = t.collapsed
        ? void 0
        : this.findLocationFromContainerAndOffset(t.endContainer, t.endOffset, e);
      return y([n, r]);
    }
    didMouseDown() {
    ...
    getLocationAtPoint(t) {
      ...
      var n;
      if (e)
        return (n = this.createLocationRangeFromDOMRange(e)) === null || n === void 0
          ? void 0
          : n[0];
    }
...
var Xr = Object.freeze({
  ...
  en = class extends R {
    ...
    installAttachmentEditorForAttachment(t, e) {
      var n;
      if (((n = this.attachmentEditor) === null || n === void 0 ? void 0 : n.attachment) === t)
        return;
  ...
  rn = class extends R {
    ...
    didMutate(t) {
      var e, n;
      if (
        (this.mutations.push(...Array.from(this.findSignificantMutations(t) || [])),
...
`)
  ...
  Us = (i, t) => Sr(i) === Sr(t),
  Vs = new RegExp('('.concat('\uFFFC', '|').concat(ln, '|').concat(ft, '|\\s)+'), 'g'),
  ...
  $t = class extends R {
    ...
    handleInput(t) {
      try {
        var e;
        ((e = this.delegate) === null || e === void 0 || e.inputControllerWillHandleInput(),
          t.call(this));
      } finally {
        var n;
...
` && !o;
      if ((s && !l) || (l && !s)) {
        ...
        if (u) {
          var c;
          let d = s ? e.replace(/\n$/, '').length || -1 : e?.length || 1;
          if ((c = this.responder) !== null && c !== void 0 && c.positionIsBlockBreak(u[1] + d))
            return !0;
        }
      }
      return r && o;
    ...
    deleteInDirection(t, e) {
      var n;
      return ((n = this.responder) === null || n === void 0 ? void 0 : n.deleteInDirection(t)) !==
        !1
    ...
    if (n) {
      ...
      if (F) {
        ...
        (!F.name && k && (F.name = 'pasted-file-'.concat(++Hs, '.').concat(k)),
          ...
          (Qt = this.responder) === null || Qt === void 0 || Qt.insertFile(e.file),
          this.requestRender(),
          (te = this.delegate) === null || te === void 0 || te.inputControllerDidPaste(e));
      }
    }
    i.preventDefault();
  },
    ...
    start(t) {
      if (((this.data.start = t), this.isSignificant())) {
        ...
        (this.inputSummary.eventName === 'keypress' &&
          ...
          (this.range =
            (e = this.responder) === null || e === void 0 ? void 0 : e.getSelectedRange()));
      }
    }
    update(t) {
...
var wt = class extends $t {
  ...
  getTargetDOMRange() {
    var t, e;
    let { minLength: n } =
        arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : { minLength: 0 },
...
var Ys = function (i) {
  ...
  to = function (i) {
    ...
    if (t)
      return (
        Array.from(t.types).filter((e) => e.match(/file/i)).length === t.types.length &&
        t.files.length >= 1
      );
  },
  Xs = function (i) {
  ...
  sn = class extends R {
    constructor(t) {
      (super(t),
        ...
        S('click', { onElement: this.element, matchingSelector: Qs, preventDefault: !0 }),
        S('click', {
          onElement: this.element,
          matchingSelector: ea,
    ...
    showDialog(t) {
      var e, n;
      (this.hideDialog(),
        (e = this.delegate) === null || e === void 0 || e.toolbarWillShowDialog());
    ...
    isSafeAttribute(t) {
      return (
        !t.hasAttribute('data-trix-validate-href') || Ve.isValidAttribute('a', 'href', t.value)
      );
    }
    removeAttribute(t) {
      var e;
      let n = Ut(t);
      return (
        (e = this.delegate) === null || e === void 0 || e.toolbarDidRemoveAttribute(n),
        this.hideDialog()
      );
    }
    hideDialog() {
    ...
    constructor(t) {
      ...
      (super(...arguments),
        ...
        (this.inputController =
          bi.getLevel() === 2 ? new wt(this.editorElement) : new $(this.editorElement)),
...
var Kn = new WeakMap(),
  ...
  Xt = class extends HTMLElement {
    ...
    set value(t) {
      var e;
      ((this.defaultValue = t),
        (e = this.editor) === null || e === void 0 || e.loadHTML(this.defaultValue));
    }
    ...
    connectedCallback() {
      this.hasAttribute('data-trix-internal') ||
        ...
        this.editorController ||
          ...
          requestAnimationFrame(() => de('trix-initialize', { onElement: this }))),
...
(Object.assign(Z, Xr),
  ...
  setTimeout(function () {
    (customElements.get('trix-toolbar') || customElements.define('trix-toolbar', an),
      customElements.get('trix-editor') || customElements.define('trix-editor', Xt));
  }, 0));

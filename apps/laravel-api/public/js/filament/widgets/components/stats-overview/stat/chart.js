...
function Bi(i, t, e) {
  ...
  if (i._sorted) {
    ...
    (d &&
      (n = Y(Math.min(at(r, a.axis, c).lo, e ? s : at(t, l, a.getPixelForValue(c)).lo), 0, s - 1)),
      u
        ? (o =
            Y(
              Math.max(
...
function aa(i) {
  return (
    i && (i.a < 255 ? `rgba(${i.r}, ${i.g}, ${i.b}, ${ut(i.a)})` : `rgb(${i.r}, ${i.g}, ${i.b})`)
  );
}
...
function Fs(i) {
  ...
  return (
    Array.isArray(i)
      ? i.length >= 3 &&
        ((t = { r: i[0], g: i[1], b: i[2], a: 255 }), i.length > 3 && (t.a = yt(i[3])))
  ...
  updateElements(t, e, s, n) {
    ...
    for (let v = e; v < e + s; ++v) {
      let y = t[v],
        ...
        k = (M[f] =
          o || w ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, x, l) : x[f], v));
    ...
    updateElements(t, e, s, n) {
      ...
      for (let y = e; y < e + s; ++y) {
        let x = t[y],
          ...
          L = (w[g] =
            o || S ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, M, l) : M[g], y));
  ...
  gi = class extends it {
    ...
    drawTitle() {
      ...
      if (this.isHorizontal())
        ...
        h =
          c + X(t.align, this.top, this.bottom - g - t.labels.padding - this._computeTitleHeight());
      }
      let f = X(r, d, d + u);
  ...
  ((k = Math.ceil(m / x) - Math.floor(p / x)),
    ...
    b && _ && o && Us((r - a) / o, x / 1e3)
      ...
      : v
        ...
        : ((k = (S - w) / x),
          Ut(k, Math.round(k), x / 1e3) ? (k = Math.round(k)) : (k = Math.ceil(k))));
...
function co(i, t) {
  ...
  return (
    ...
    a === null
      ? null
      : (n &&
          (a = n === 'week' && (Lt(o) || o === !0) ? e.startOf(a, 'isoWeek', o) : e.startOf(a, n)),
        +a)
  );
}
function ho(i, t, e, s) {

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('booking_holds', function (Blueprint $table) {
            ...
            $table->index('slot_id', 'idx_holds_slot_id');
        ...
        Schema::table('availability_slots', function (Blueprint $table) {
            ...
            $table->index(['listing_id', 'date', 'status'], 'idx_slots_listing_date_status');
        });
        ...
        Schema::table('availability_rules', function (Blueprint $table) {
            ...
            $table->index('is_active', 'idx_rules_is_active');
            $table->index(['listing_id', 'is_active'], 'idx_rules_listing_active');
        });
        ...
        Schema::table('payment_intents', function (Blueprint $table) {
            ...
            $table->index('gateway_id', 'idx_payment_intents_gateway_id');
        ...
        Schema::table('reviews', function (Blueprint $table) {
            ...
            $table->index('is_published', 'idx_reviews_is_published');
            $table->index('rating', 'idx_reviews_rating');
            $table->index('created_at', 'idx_reviews_created_at');
            // Composite indexes
            $table->index(['listing_id', 'is_published'], 'idx_reviews_listing_published');
    ...
    public function down(): void
    {
        ...
        Schema::table('reviews', function (Blueprint $table) {
            ...
            $table->dropIndex('idx_reviews_is_published');
            $table->dropIndex('idx_reviews_rating');
            $table->dropIndex('idx_reviews_created_at');
            $table->dropIndex('idx_reviews_listing_published');
        ...
        Schema::table('availability_rules', function (Blueprint $table) {
            ...
            $table->dropIndex('idx_rules_is_active');
            $table->dropIndex('idx_rules_listing_active');
        });
        ...
        Schema::table('availability_slots', function (Blueprint $table) {
            ...
            $table->dropIndex('idx_slots_listing_date_status');
        });

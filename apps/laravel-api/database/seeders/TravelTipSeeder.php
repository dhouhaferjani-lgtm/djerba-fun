...
class TravelTipSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $tips = [
            ...
            [
                'content' => [
                    'en' => 'Respect local Berber traditions and always ask permission before photographing people.',
                    'fr' => 'Respectez les traditions berbères locales et demandez toujours la permission avant de photographier les gens.',
                ],
                'display_order' => 3,
            ],
            [
